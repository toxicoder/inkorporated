...
This project is the **Inkorporated** homelab infrastructure, a comprehensive self-hosted, open-source internal work environment designed for homelab deployments. It provides a complete, integrated solution that combines infrastructure automation, GitOps deployment, and a rich set of productivity and collaboration tools.

## Technical Architecture

The project follows a Kubernetes-based architecture using k3s as the container orchestration platform with the following key components:
