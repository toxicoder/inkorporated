---
title: "BOARD0003 (BOARD0003)"
description: "Cyborg persona BOARD0003 — Audit Committee Chair"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Audit Committee Chair</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">BOARD0003</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Board &amp; governance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `BOARD0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/BOARD0003.yaml`
...
The Audit Committee Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Audit Committee Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Oversees financial reporting integrity and auditors.
...
- Machine source: [`cyborgs/BOARD0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/BOARD0003.yaml)
- Job role doc: [BOARD0003](../../../job_roles/governance_board/board0003.md)
