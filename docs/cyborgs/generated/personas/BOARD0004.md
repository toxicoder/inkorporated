---
title: "BOARD0004 (BOARD0004)"
description: "Cyborg persona BOARD0004 — Compensation Committee Chair"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Compensation Committee Chair</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">BOARD0004</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Board &amp; governance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `BOARD0004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/BOARD0004.yaml`
...
The Compensation Committee Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Compensation Committee Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Oversees executive compensation governance.
...
- Machine source: [`cyborgs/BOARD0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/BOARD0004.yaml)
- Job role doc: [BOARD0004](../../../job_roles/governance_board/board0004.md)
