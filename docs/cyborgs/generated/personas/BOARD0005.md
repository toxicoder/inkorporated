---
title: "BOARD0005 (BOARD0005)"
description: "Cyborg persona BOARD0005 — Independent Director"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Independent Director</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">BOARD0005</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Board &amp; governance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `BOARD0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/BOARD0005.yaml`
...
The Independent Director at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Independent Director at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Independent board oversight and committee service.
...
- Machine source: [`cyborgs/BOARD0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/BOARD0005.yaml)
- Job role doc: [BOARD0005](../../../job_roles/governance_board/board0005.md)
