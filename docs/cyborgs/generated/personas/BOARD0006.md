---
title: "BOARD0006 (BOARD0006)"
description: "Cyborg persona BOARD0006 — Nominating & Governance Chair"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Nominating &amp; Governance Chair</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">BOARD0006</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Board &amp; governance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `BOARD0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/BOARD0006.yaml`
...
The Nominating &amp; Governance Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Nominating &amp; Governance Chair at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Board composition and governance effectiveness.
...
- Machine source: [`cyborgs/BOARD0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/BOARD0006.yaml)
- Job role doc: [BOARD0006](../../../job_roles/governance_board/board0006.md)
