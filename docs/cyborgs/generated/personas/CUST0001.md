---
title: "CUST0001 (CUST0001)"
description: "Cyborg persona CUST0001 — Support Engineer L1"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Support Engineer L1</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0001</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0001.yaml`
...
The Support Engineer L1 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Support Engineer L1 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. First-line customer support and triage.
...
## Identity & mission
The Support Engineer L1 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. First-line customer support and triage.
...
flowchart LR
  CUST0001["CUST0001"]
  CUST0005["CUST0005"] --> CUST0001
```


## Links

- Machine source: [`cyborgs/CUST0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0001.yaml)
- Job role doc: [CUST0001](../../../job_roles/customer_experience/cust0001.md)
