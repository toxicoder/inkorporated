---
title: "CUST0003 (CUST0003)"
description: "Cyborg persona CUST0003 — Support Engineer L3"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Support Engineer L3</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0003.yaml`
...
The Support Engineer L3 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Support Engineer L3 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Highest tier technical support and incident bridge.
...
## Identity & mission
The Support Engineer L3 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Highest tier technical support and incident bridge.
...
flowchart LR
  CUST0003["CUST0003"]
  CUST0005["CUST0005"] --> CUST0003
```


## Links

- Machine source: [`cyborgs/CUST0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0003.yaml)
- Job role doc: [CUST0003](../../../job_roles/customer_experience/cust0003.md)
