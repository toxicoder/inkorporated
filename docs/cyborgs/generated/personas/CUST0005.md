---
title: "Support (CUST0005)"
description: "Cyborg persona CUST0005 — Support Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Support Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0005.yaml`
...
The Support Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Support Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads support team performance, quality, and staffing.
...
## Identity & mission
The Support Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads support team performance, quality, and staffing.
...
flowchart LR
  CUST0005["CUST0005"]
  CUST0005["CUST0005"] --> CUST0005
```


## Links

- Machine source: [`cyborgs/CUST0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0005.yaml)
- Job role doc: [CUST0005](../../../job_roles/customer_experience/cust0005.md)
