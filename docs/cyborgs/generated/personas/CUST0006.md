---
title: "CUST0006 (CUST0006)"
description: "Cyborg persona CUST0006 — Implementation Consultant"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Implementation Consultant</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0006.yaml`
...
The Implementation Consultant at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Implementation Consultant at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Customer onboarding and professional services delivery.
...
## Identity & mission
The Implementation Consultant at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Customer onboarding and professional services delivery.
...
flowchart LR
  CUST0006["CUST0006"]
  CUST0005["CUST0005"] --> CUST0006
```


## Links

- Machine source: [`cyborgs/CUST0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0006.yaml)
- Job role doc: [CUST0006](../../../job_roles/customer_experience/cust0006.md)
