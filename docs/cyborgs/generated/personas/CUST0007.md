---
title: "CUST0007 (CUST0007)"
description: "Cyborg persona CUST0007 — Professional Services Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Professional Services Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0007</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0007.yaml`
...
The Professional Services Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Professional Services Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. PS utilization, delivery quality, and staffing.
...
## Identity & mission
The Professional Services Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. PS utilization, delivery quality, and staffing.
...
flowchart LR
  CUST0007["CUST0007"]
  CUST0005["CUST0005"] --> CUST0007
```


## Links

- Machine source: [`cyborgs/CUST0007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0007.yaml)
- Job role doc: [CUST0007](../../../job_roles/customer_experience/cust0007.md)
