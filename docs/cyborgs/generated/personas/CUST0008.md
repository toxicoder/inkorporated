---
title: "CUST0008 (CUST0008)"
description: "Cyborg persona CUST0008 — Customer Support Operations"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Customer Support Operations</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">CUST0008</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-customer">cyborg-customer</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Customer experience</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `CUST0008`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/CUST0008.yaml`
...
The Customer Support Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Customer Support Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Support tooling, SLAs, and workforce management.
...
## Identity & mission
The Customer Support Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Support tooling, SLAs, and workforce management.
...
flowchart LR
  CUST0008["CUST0008"]
  CUST0005["CUST0005"] --> CUST0008
```


## Links

- Machine source: [`cyborgs/CUST0008.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0008.yaml)
- Job role doc: [CUST0008](../../../job_roles/customer_experience/cust0008.md)
