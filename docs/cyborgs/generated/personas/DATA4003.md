---
title: "DATA4003 (DATA4003)"
description: "Cyborg persona DATA4003 — Analytics Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Analytics Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DATA4003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Data</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DATA4003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DATA4003.yaml`
...
The Analytics Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Analytics Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds trustworthy analytics models and semantic layers.
...
flowchart LR
  DATA4003["DATA4003"]
  EXEC0009["EXEC0009"] --> DATA4003
```


## Links

- Machine source: [`cyborgs/DATA4003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4003.yaml)
- Job role doc: [DATA4003](../../../job_roles/data_analytics/data4003.md)
