---
title: "DATA4004 (DATA4004)"
description: "Cyborg persona DATA4004 — Business Intelligence Analyst"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Business Intelligence Analyst</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DATA4004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Data</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DATA4004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DATA4004.yaml`
...
The Business Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Business Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Delivers dashboards and decision support analytics.
...
flowchart LR
  DATA4004["DATA4004"]
  EXEC0009["EXEC0009"] --> DATA4004
```


## Links

- Machine source: [`cyborgs/DATA4004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4004.yaml)
- Job role doc: [DATA4004](../../../job_roles/data_analytics/data4004.md)
