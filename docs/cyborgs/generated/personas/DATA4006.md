---
title: "DATA4006 (DATA4006)"
description: "Cyborg persona DATA4006 — MLOps Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">MLOps Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DATA4006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Data</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DATA4006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DATA4006.yaml`
...
The MLOps Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The MLOps Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Productionizes ML pipelines, registries, and monitoring.
...
flowchart LR
  DATA4006["DATA4006"]
  EXEC0009["EXEC0009"] --> DATA4006
```


## Links

- Machine source: [`cyborgs/DATA4006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4006.yaml)
- Job role doc: [DATA4006](../../../job_roles/data_analytics/data4006.md)
