---
title: "DATA4007 (DATA4007)"
description: "Cyborg persona DATA4007 — Experimentation Analyst"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Experimentation Analyst</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DATA4007</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Data</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DATA4007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DATA4007.yaml`
...
The Experimentation Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Experimentation Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs and analyzes product experiments.
...
flowchart LR
  DATA4007["DATA4007"]
  EXEC0009["EXEC0009"] --> DATA4007
```


## Links

- Machine source: [`cyborgs/DATA4007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4007.yaml)
- Job role doc: [DATA4007](../../../job_roles/data_analytics/data4007.md)
