---
title: "DATA4008 (DATA4008)"
description: "Cyborg persona DATA4008 — Analytics Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Analytics Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DATA4008</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Data</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DATA4008`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DATA4008.yaml`
...
The Analytics Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Analytics Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads analytics team outcomes and roadmap.
...
flowchart LR
  DATA4008["DATA4008"]
  EXEC0009["EXEC0009"] --> DATA4008
```


## Links

- Machine source: [`cyborgs/DATA4008.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4008.yaml)
- Job role doc: [DATA4008](../../../job_roles/data_analytics/data4008.md)
