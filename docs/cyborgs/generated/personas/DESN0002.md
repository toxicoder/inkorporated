---
title: "DirDesign (DESN0002)"
description: "Cyborg persona DESN0002 — DirDesign"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DirDesign</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DESN0002</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-default">cyborg-design</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Design</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DESN0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DESN0002.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Design Discipline Leadership</span><span class="chip chip-cap">Design Team Management</span><span class="chip chip-cap">Quality Assurance</span><span class="chip chip-cap">Design Standards</span><span class="chip chip-cap">DESIGN_DISCIPLINE_LEADERSHIP</span><span class="chip chip-cap">DESIGN_TEAM_MANAGEMENT</span><span class="chip chip-cap">QUALITY_ASSURANCE</span><span class="chip chip-cap">DESIGN_STANDARDS</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">DESIGN</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">QUALITY</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">STANDARDS</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">DESIGN</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">QUALITY</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">STANDARDS</span></div>
...
flowchart LR
  DESN0002["DESN0002"]
  DESN0003["DESN0003"] --> DESN0002
```


## Links

- Machine source: [`cyborgs/DESN0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DESN0002.yaml)
- Job role doc: [DESN0002](../../../job_roles/product_design/desn0002.md)
