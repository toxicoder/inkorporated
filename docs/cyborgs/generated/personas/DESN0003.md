---
title: "DesignMgr (DESN0003)"
description: "Cyborg persona DESN0003 — DesignMgr"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DesignMgr</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DESN0003</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-default">cyborg-design</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Design</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DESN0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DESN0003.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Team Management</span><span class="chip chip-cap">Critique Facilitation</span><span class="chip chip-cap">Quality Assurance</span><span class="chip chip-cap">Design Standards</span><span class="chip chip-cap">TEAM_MANAGEMENT</span><span class="chip chip-cap">CRITIQUE_FACILITATION</span><span class="chip chip-cap">QUALITY_ASSURANCE</span><span class="chip chip-cap">DESIGN_STANDARDS</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">DESIGN</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">QUALITY</span><span class="chip chip-tag">CRITIQUE</span><span class="chip chip-tag">STANDARDS</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">COORDINATION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">DESIGN</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">QUALITY</span><span class="chip chip-tag">CRITIQUE</span><span class="chip chip-tag">STANDARDS</span></div>
...
flowchart LR
  DESN0003["DESN0003"]
  DESN0003["DESN0003"] --> DESN0003
```


## Links

- Machine source: [`cyborgs/DESN0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DESN0003.yaml)
- Job role doc: [DESN0003](../../../job_roles/product_design/desn0003.md)
