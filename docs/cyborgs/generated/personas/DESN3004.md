---
title: "DESN3004 (DESN3004)"
description: "Cyborg persona DESN3004 — Design Systems Designer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Design Systems Designer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DESN3004</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Design</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DESN3004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DESN3004.yaml`
...
The Design Systems Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Design Systems Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns design system components and governance.
...
## Identity & mission
The Design Systems Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns design system components and governance.
...
flowchart LR
  DESN3004["DESN3004"]
  DESN0003["DESN0003"] --> DESN3004
```


## Links

- Machine source: [`cyborgs/DESN3004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DESN3004.yaml)
- Job role doc: [DESN3004](../../../job_roles/product_design/desn3004.md)
