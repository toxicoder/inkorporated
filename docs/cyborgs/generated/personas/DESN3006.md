---
title: "DESN3006 (DESN3006)"
description: "Cyborg persona DESN3006 — Content Designer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Content Designer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">DESN3006</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Design</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `DESN3006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/DESN3006.yaml`
...
The Content Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Content Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Product content strategy and in-product language.
...
## Identity & mission
The Content Designer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Product content strategy and in-product language.
...
flowchart LR
  DESN3006["DESN3006"]
  DESN0003["DESN0003"] --> DESN3006
```


## Links

- Machine source: [`cyborgs/DESN3006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DESN3006.yaml)
- Job role doc: [DESN3006](../../../job_roles/product_design/desn3006.md)
