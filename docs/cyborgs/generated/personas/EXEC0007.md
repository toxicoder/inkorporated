---
title: "COO (EXEC0007)"
description: "Cyborg persona EXEC0007 — COO: Chief Operating Officer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">COO: Chief Operating Officer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">EXEC0007</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Executive</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `EXEC0007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/EXEC0007.yaml`
...
The COO: Chief Operating Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The COO: Chief Operating Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns operating cadence, cross-functional execution, and operational excellence.
...
## Identity & mission
The COO: Chief Operating Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns operating cadence, cross-functional execution, and operational excellence.
...
flowchart LR
  EXEC0007["EXEC0007"]
  EXEC0001["EXEC0001"] --> EXEC0007
```


## Links

- Machine source: [`cyborgs/EXEC0007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/EXEC0007.yaml)
- Job role doc: [EXEC0007](../../../job_roles/executive_leadership/exec0007.md)
