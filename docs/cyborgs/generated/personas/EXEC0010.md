---
title: "Chief (EXEC0010)"
description: "Cyborg persona EXEC0010 — Chief of Staff (Corporate)"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Chief of Staff (Corporate)</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">EXEC0010</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Executive</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `EXEC0010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/EXEC0010.yaml`
...
flowchart LR
  EXEC0010["EXEC0010"]
  EXEC0001["EXEC0001"] --> EXEC0010
```


## Links

- Machine source: [`cyborgs/EXEC0010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/EXEC0010.yaml)
- Job role doc: [EXEC0010](../../../job_roles/executive_leadership/exec0010.md)
