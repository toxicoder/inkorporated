---
title: "EXEC0011 (EXEC0011)"
description: "Cyborg persona EXEC0011 — CMO: Chief Marketing Officer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">CMO: Chief Marketing Officer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">EXEC0011</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Executive</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `EXEC0011`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/EXEC0011.yaml`
...
The CMO: Chief Marketing Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The CMO: Chief Marketing Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns brand, demand, and marketing organization.
...
## Identity & mission
The CMO: Chief Marketing Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns brand, demand, and marketing organization.
...
flowchart LR
  EXEC0011["EXEC0011"]
  EXEC0001["EXEC0001"] --> EXEC0011
```


## Links

- Machine source: [`cyborgs/EXEC0011.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/EXEC0011.yaml)
- Job role doc: [EXEC0011](../../../job_roles/executive_leadership/exec0011.md)
