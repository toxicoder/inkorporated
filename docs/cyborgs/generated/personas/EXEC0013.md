---
title: "EXEC0013 (EXEC0013)"
description: "Cyborg persona EXEC0013 — CHRO: Chief Human Resources Officer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">CHRO: Chief Human Resources Officer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">EXEC0013</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-executive">cyborg-executive</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Executive</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `EXEC0013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/EXEC0013.yaml`
...
The CHRO: Chief Human Resources Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The CHRO: Chief Human Resources Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns people strategy at C-level when elevated.
...
## Identity & mission
The CHRO: Chief Human Resources Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns people strategy at C-level when elevated.
...
flowchart LR
  EXEC0013["EXEC0013"]
  EXEC0001["EXEC0001"] --> EXEC0013
```


## Links

- Machine source: [`cyborgs/EXEC0013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/EXEC0013.yaml)
- Job role doc: [EXEC0013](../../../job_roles/executive_leadership/exec0013.md)
