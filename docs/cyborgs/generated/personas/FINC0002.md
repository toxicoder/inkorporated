---
title: "DirFinance (FINC0002)"
description: "Cyborg persona FINC0002 — DirFinance"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DirFinance</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC0002</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-finance</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC0002.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Finance Function Leadership</span><span class="chip chip-cap">Team Management</span><span class="chip chip-cap">Reporting Oversight</span><span class="chip chip-cap">Financial Analysis</span><span class="chip chip-cap">FINANCE_FUNCTION_LEADERSHIP</span><span class="chip chip-cap">TEAM_MANAGEMENT</span><span class="chip chip-cap">REPORTING_OVERSIGHT</span><span class="chip chip-cap">FINANCIAL_ANALYSIS</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">FINANCE</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">TEAM_MANAGEMENT</span><span class="chip chip-tag">REPORTING</span><span class="chip chip-tag">ANALYSIS</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">FINANCE</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">TEAM_MANAGEMENT</span><span class="chip chip-tag">REPORTING</span><span class="chip chip-tag">ANALYSIS</span></div>
...
flowchart LR
  FINC0002["FINC0002"]
  FINC0002["FINC0002"] --> FINC0002
```


## Links

- Machine source: [`cyborgs/FINC0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC0002.yaml)
- Job role doc: [FINC0002](../../../job_roles/ga_general_administrative/finc0002.md)
