---
title: "Internal (FINC6010)"
description: "Cyborg persona FINC6010 — Internal Auditor"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Internal Auditor</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6010</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6010.yaml`
...
The Internal Auditor at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Internal Auditor at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Independent assurance over controls and financial processes.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">FINC</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">Controller Mindset</span><span class="chip chip-tag">FP&amp;A Partner</span><span class="chip chip-tag">Capital Discipline</span><span class="chip chip-tag">Risk Radar</span><span class="chip chip-tag">Clarity Writer</span></div>
...
## Identity & mission
The Internal Auditor at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Independent assurance over controls and financial processes.
...
flowchart LR
  FINC6010["FINC6010"]
  FINC0002["FINC0002"] --> FINC6010
```


## Links

- Machine source: [`cyborgs/FINC6010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6010.yaml)
- Job role doc: [FINC6010](../../../job_roles/ga_general_administrative/finc6010.md)
