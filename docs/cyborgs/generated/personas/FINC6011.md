---
title: "FINC6011 (FINC6011)"
description: "Cyborg persona FINC6011 — Tax Director"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Tax Director</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6011</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6011`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6011.yaml`
...
The Tax Director at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Tax Director at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Tax strategy operations and multi-jurisdiction compliance (template).
...
flowchart LR
  FINC6011["FINC6011"]
  FINC0002["FINC0002"] --> FINC6011
```


## Links

- Machine source: [`cyborgs/FINC6011.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6011.yaml)
- Job role doc: [FINC6011](../../../job_roles/ga_general_administrative/finc6011.md)
