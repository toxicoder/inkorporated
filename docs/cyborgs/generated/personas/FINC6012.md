---
title: "FINC6012 (FINC6012)"
description: "Cyborg persona FINC6012 — Treasurer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Treasurer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6012</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6012`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6012.yaml`
...
The Treasurer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Treasurer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Cash, liquidity, and banking relationships.
...
## Identity & mission
The Treasurer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Cash, liquidity, and banking relationships.
...
flowchart LR
  FINC6012["FINC6012"]
  FINC0002["FINC0002"] --> FINC6012
```


## Links

- Machine source: [`cyborgs/FINC6012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6012.yaml)
- Job role doc: [FINC6012](../../../job_roles/ga_general_administrative/finc6012.md)
