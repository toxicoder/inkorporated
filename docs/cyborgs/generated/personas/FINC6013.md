---
title: "FINC6013 (FINC6013)"
description: "Cyborg persona FINC6013 — Procurement Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Procurement Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6013</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6013.yaml`
...
The Procurement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Procurement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Vendor selection, contracts process, and spend control.
...
## Identity & mission
The Procurement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Vendor selection, contracts process, and spend control.
...
flowchart LR
  FINC6013["FINC6013"]
  FINC0002["FINC0002"] --> FINC6013
```


## Links

- Machine source: [`cyborgs/FINC6013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6013.yaml)
- Job role doc: [FINC6013](../../../job_roles/ga_general_administrative/finc6013.md)
