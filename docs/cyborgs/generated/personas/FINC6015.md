---
title: "FINC6015 (FINC6015)"
description: "Cyborg persona FINC6015 — Accounts Payable Specialist"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Accounts Payable Specialist</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6015</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6015`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6015.yaml`
...
The Accounts Payable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Accounts Payable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Vendor payments and AP controls.
...
## Identity & mission
The Accounts Payable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Vendor payments and AP controls.
...
flowchart LR
  FINC6015["FINC6015"]
  FINC0002["FINC0002"] --> FINC6015
```


## Links

- Machine source: [`cyborgs/FINC6015.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6015.yaml)
- Job role doc: [FINC6015](../../../job_roles/ga_general_administrative/finc6015.md)
