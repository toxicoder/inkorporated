---
title: "FINC6016 (FINC6016)"
description: "Cyborg persona FINC6016 — Accounts Receivable Specialist"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Accounts Receivable Specialist</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6016</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6016`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6016.yaml`
...
The Accounts Receivable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Accounts Receivable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Collections, invoicing, and cash application.
...
## Identity & mission
The Accounts Receivable Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Collections, invoicing, and cash application.
...
flowchart LR
  FINC6016["FINC6016"]
  FINC0002["FINC0002"] --> FINC6016
```


## Links

- Machine source: [`cyborgs/FINC6016.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6016.yaml)
- Job role doc: [FINC6016](../../../job_roles/ga_general_administrative/finc6016.md)
