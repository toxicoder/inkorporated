---
title: "FINC6017 (FINC6017)"
description: "Cyborg persona FINC6017 — Investor Relations Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Investor Relations Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6017</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6017`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6017.yaml`
...
The Investor Relations Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Investor Relations Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Investor communications and materials (with CFO/CEO).
...
## Identity & mission
The Investor Relations Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Investor communications and materials (with CFO/CEO).
...
flowchart LR
  FINC6017["FINC6017"]
  FINC0002["FINC0002"] --> FINC6017
```


## Links

- Machine source: [`cyborgs/FINC6017.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6017.yaml)
- Job role doc: [FINC6017](../../../job_roles/ga_general_administrative/finc6017.md)
