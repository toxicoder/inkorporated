---
title: "FINC6018 (FINC6018)"
description: "Cyborg persona FINC6018 — FP&A Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">FP&amp;A Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">FINC6018</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Finance</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `FINC6018`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/FINC6018.yaml`
...
The FP&amp;A Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The FP&amp;A Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads planning, forecasting, and business partnering.
...
## Identity & mission
The FP&A Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads planning, forecasting, and business partnering.
...
flowchart LR
  FINC6018["FINC6018"]
  FINC0002["FINC0002"] --> FINC6018
```


## Links

- Machine source: [`cyborgs/FINC6018.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/FINC6018.yaml)
- Job role doc: [FINC6018](../../../job_roles/ga_general_administrative/finc6018.md)
