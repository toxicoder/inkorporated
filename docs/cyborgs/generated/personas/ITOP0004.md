---
title: "ITOP0004 (ITOP0004)"
description: "Cyborg persona ITOP0004 — ITSM Administrator"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">ITSM Administrator</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">ITOP0004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Corporate IT</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `ITOP0004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/ITOP0004.yaml`
...
The ITSM Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The ITSM Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Service desk platform and corporate IT processes.
...
## Identity & mission
The ITSM Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Service desk platform and corporate IT processes.
...
flowchart LR
  ITOP0004["ITOP0004"]
  ITOP0006["ITOP0006"] --> ITOP0004
```


## Links

- Machine source: [`cyborgs/ITOP0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/ITOP0004.yaml)
- Job role doc: [ITOP0004](../../../job_roles/corporate_it/itop0004.md)
