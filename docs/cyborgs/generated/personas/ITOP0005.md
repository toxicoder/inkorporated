---
title: "ITOP0005 (ITOP0005)"
description: "Cyborg persona ITOP0005 — Corporate Network Administrator"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Corporate Network Administrator</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">ITOP0005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Corporate IT</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `ITOP0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/ITOP0005.yaml`
...
The Corporate Network Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Corporate Network Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Office and corp network reliability.
...
## Identity & mission
The Corporate Network Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Office and corp network reliability.
...
flowchart LR
  ITOP0005["ITOP0005"]
  ITOP0006["ITOP0006"] --> ITOP0005
```


## Links

- Machine source: [`cyborgs/ITOP0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/ITOP0005.yaml)
- Job role doc: [ITOP0005](../../../job_roles/corporate_it/itop0005.md)
