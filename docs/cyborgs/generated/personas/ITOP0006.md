---
title: "ITOP0006 (ITOP0006)"
description: "Cyborg persona ITOP0006 — IT Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">IT Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">ITOP0006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Corporate IT</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `ITOP0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/ITOP0006.yaml`
...
The IT Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The IT Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Corporate IT team leadership and service levels.
...
flowchart LR
  ITOP0006["ITOP0006"]
  ITOP0006["ITOP0006"] --> ITOP0006
```


## Links

- Machine source: [`cyborgs/ITOP0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/ITOP0006.yaml)
- Job role doc: [ITOP0006](../../../job_roles/corporate_it/itop0006.md)
