---
title: "ITOP0007 (ITOP0007)"
description: "Cyborg persona ITOP0007 — IT Support L2"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">IT Support L2</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">ITOP0007</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Corporate IT</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `ITOP0007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/ITOP0007.yaml`
...
The IT Support L2 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The IT Support L2 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Complex endpoint and access issues.
...
## Identity & mission
The IT Support L2 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Complex endpoint and access issues.
...
flowchart LR
  ITOP0007["ITOP0007"]
  ITOP0006["ITOP0006"] --> ITOP0007
```


## Links

- Machine source: [`cyborgs/ITOP0007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/ITOP0007.yaml)
- Job role doc: [ITOP0007](../../../job_roles/corporate_it/itop0007.md)
