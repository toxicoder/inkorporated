---
title: "Compliance (LEGL7010)"
description: "Cyborg persona LEGL7010 — Compliance Officer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Compliance Officer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">LEGL7010</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Legal</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `LEGL7010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/LEGL7010.yaml`
...
The Compliance Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Compliance Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Operates compliance program and regulatory obligations.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">LEGL</span></div>
...
## Identity & mission
The Compliance Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Operates compliance program and regulatory obligations.
...
flowchart LR
  LEGL7010["LEGL7010"]
  EXEC0006["EXEC0006"] --> LEGL7010
```


## Links

- Machine source: [`cyborgs/LEGL7010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/LEGL7010.yaml)
- Job role doc: [LEGL7010](../../../job_roles/ga_general_administrative/legl7010.md)
