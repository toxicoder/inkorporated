---
title: "Privacy (LEGL7011)"
description: "Cyborg persona LEGL7011 — Privacy Counsel"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Privacy Counsel</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">LEGL7011</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Legal</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `LEGL7011`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/LEGL7011.yaml`
...
The Privacy Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Privacy Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Advises on privacy law, DPIAs, and data subject rights.
...
## Identity & mission
The Privacy Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Advises on privacy law, DPIAs, and data subject rights.
...
flowchart LR
  LEGL7011["LEGL7011"]
  EXEC0006["EXEC0006"] --> LEGL7011
```


## Links

- Machine source: [`cyborgs/LEGL7011.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/LEGL7011.yaml)
- Job role doc: [LEGL7011](../../../job_roles/ga_general_administrative/legl7011.md)
