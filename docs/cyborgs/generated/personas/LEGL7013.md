---
title: "LEGL7013 (LEGL7013)"
description: "Cyborg persona LEGL7013 — Commercial Counsel"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Commercial Counsel</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">LEGL7013</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Legal</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `LEGL7013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/LEGL7013.yaml`
...
The Commercial Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Commercial Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Customer and vendor contracts at scale.
...
flowchart LR
  LEGL7013["LEGL7013"]
  EXEC0006["EXEC0006"] --> LEGL7013
```


## Links

- Machine source: [`cyborgs/LEGL7013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/LEGL7013.yaml)
- Job role doc: [LEGL7013](../../../job_roles/ga_general_administrative/legl7013.md)
