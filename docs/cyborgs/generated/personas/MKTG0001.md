---
title: "VPMarketing (MKTG0001)"
description: "Cyborg persona MKTG0001 — VPMarketing"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">VPMarketing</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG0001</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-default">cyborg-marketing</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG0001.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Marketing Leadership</span><span class="chip chip-cap">Brand Strategy</span><span class="chip chip-cap">Demand Generation</span><span class="chip chip-cap">Product Positioning</span><span class="chip chip-cap">MARKETING_LEADERSHIP</span><span class="chip chip-cap">BRAND_STRATEGY</span><span class="chip chip-cap">DEMAND_GENERATION</span><span class="chip chip-cap">PRODUCT_POSITIONING</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">MARKETING</span><span class="chip chip-tag">BRAND</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">DEMAND_GEN</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">PERFORMANCE</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">MARKETING</span><span class="chip chip-tag">BRAND</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">DEMAND_GEN</span></div>
...
flowchart LR
  MKTG0001["MKTG0001"]
  MKTG0002["MKTG0002"] --> MKTG0001
```


## Links

- Machine source: [`cyborgs/MKTG0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG0001.yaml)
- Job role doc: [MKTG0001](../../../job_roles/go_to_market_sales_marketing/mktg0001.md)
