---
title: "Product (MKTG9010)"
description: "Cyborg persona MKTG9010 — Product Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Product Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9010</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9010.yaml`
...
The Product Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Product Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Positioning, packaging, and sales enablement for products.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">MKTG</span></div>
...
## Identity & mission
The Product Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Positioning, packaging, and sales enablement for products.
...
flowchart LR
  MKTG9010["MKTG9010"]
  MKTG0002["MKTG0002"] --> MKTG9010
```


## Links

- Machine source: [`cyborgs/MKTG9010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9010.yaml)
- Job role doc: [MKTG9010](../../../job_roles/go_to_market_sales_marketing/mktg9010.md)
