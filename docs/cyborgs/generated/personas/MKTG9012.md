---
title: "MKTG9012 (MKTG9012)"
description: "Cyborg persona MKTG9012 — Content Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Content Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9012</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9012`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9012.yaml`
...
The Content Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Content Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns editorial calendar and content funnel.
...
## Identity & mission
The Content Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns editorial calendar and content funnel.
...
flowchart LR
  MKTG9012["MKTG9012"]
  MKTG0002["MKTG0002"] --> MKTG9012
```


## Links

- Machine source: [`cyborgs/MKTG9012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9012.yaml)
- Job role doc: [MKTG9012](../../../job_roles/go_to_market_sales_marketing/mktg9012.md)
