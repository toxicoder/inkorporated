---
title: "MKTG9013 (MKTG9013)"
description: "Cyborg persona MKTG9013 — Growth Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Growth Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9013</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9013.yaml`
...
The Growth Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Growth Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Experimentation-led acquisition channels.
...
## Identity & mission
The Growth Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Experimentation-led acquisition channels.
...
flowchart LR
  MKTG9013["MKTG9013"]
  MKTG0002["MKTG0002"] --> MKTG9013
```


## Links

- Machine source: [`cyborgs/MKTG9013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9013.yaml)
- Job role doc: [MKTG9013](../../../job_roles/go_to_market_sales_marketing/mktg9013.md)
