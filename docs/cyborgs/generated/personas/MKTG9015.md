---
title: "MKTG9015 (MKTG9015)"
description: "Cyborg persona MKTG9015 — Field Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Field Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9015</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9015`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9015.yaml`
...
The Field Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Field Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Events, regional campaigns, and pipeline influence.
...
## Identity & mission
The Field Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Events, regional campaigns, and pipeline influence.
...
flowchart LR
  MKTG9015["MKTG9015"]
  MKTG0002["MKTG0002"] --> MKTG9015
```


## Links

- Machine source: [`cyborgs/MKTG9015.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9015.yaml)
- Job role doc: [MKTG9015](../../../job_roles/go_to_market_sales_marketing/mktg9015.md)
