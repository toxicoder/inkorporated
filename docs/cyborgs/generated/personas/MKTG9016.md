---
title: "MKTG9016 (MKTG9016)"
description: "Cyborg persona MKTG9016 — Pricing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Pricing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9016</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9016`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9016.yaml`
...
The Pricing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Pricing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Packaging, price architecture, and deal desk policy.
...
## Identity & mission
The Pricing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Packaging, price architecture, and deal desk policy.
...
flowchart LR
  MKTG9016["MKTG9016"]
  MKTG0002["MKTG0002"] --> MKTG9016
```


## Links

- Machine source: [`cyborgs/MKTG9016.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9016.yaml)
- Job role doc: [MKTG9016](../../../job_roles/go_to_market_sales_marketing/mktg9016.md)
