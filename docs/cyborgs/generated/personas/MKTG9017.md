---
title: "MKTG9017 (MKTG9017)"
description: "Cyborg persona MKTG9017 — Partner Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Partner Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9017</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9017`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9017.yaml`
...
The Partner Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Partner Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Co-marketing with channels and alliances.
...
## Identity & mission
The Partner Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Co-marketing with channels and alliances.
...
flowchart LR
  MKTG9017["MKTG9017"]
  MKTG0002["MKTG0002"] --> MKTG9017
```


## Links

- Machine source: [`cyborgs/MKTG9017.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9017.yaml)
- Job role doc: [MKTG9017](../../../job_roles/go_to_market_sales_marketing/mktg9017.md)
