---
title: "MKTG9018 (MKTG9018)"
description: "Cyborg persona MKTG9018 — Customer Marketing Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Customer Marketing Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">MKTG9018</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Marketing</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `MKTG9018`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/MKTG9018.yaml`
...
The Customer Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Customer Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Advocacy, case studies, and expansion marketing.
...
## Identity & mission
The Customer Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Advocacy, case studies, and expansion marketing.
...
flowchart LR
  MKTG9018["MKTG9018"]
  MKTG0002["MKTG0002"] --> MKTG9018
```


## Links

- Machine source: [`cyborgs/MKTG9018.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9018.yaml)
- Job role doc: [MKTG9018](../../../job_roles/go_to_market_sales_marketing/mktg9018.md)
