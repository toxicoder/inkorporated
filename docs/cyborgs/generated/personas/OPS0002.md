---
title: "OPS0002 (OPS0002)"
description: "Cyborg persona OPS0002 — Vendor Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Vendor Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">OPS0002</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Operations</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `OPS0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/OPS0002.yaml`
...
The Vendor Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Vendor Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Third-party risk and vendor performance.
...
## Identity & mission
The Vendor Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Third-party risk and vendor performance.
...
flowchart LR
  OPS0002["OPS0002"]
  EXEC0007["EXEC0007"] --> OPS0002
```


## Links

- Machine source: [`cyborgs/OPS0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/OPS0002.yaml)
- Job role doc: [OPS0002](../../../job_roles/ga_general_administrative/ops0002.md)
