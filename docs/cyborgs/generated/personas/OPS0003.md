---
title: "OPS0003 (OPS0003)"
description: "Cyborg persona OPS0003 — Business Continuity Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Business Continuity Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">OPS0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Operations</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `OPS0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/OPS0003.yaml`
...
The Business Continuity Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Business Continuity Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. BCP/DR plans and exercise cadence.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">Systems Operator</span><span class="chip chip-tag">Vendor Manager</span><span class="chip chip-tag">Continuity Planner</span><span class="chip chip-tag">Portfolio Lead</span></div>
...
## Identity & mission
The Business Continuity Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. BCP/DR plans and exercise cadence.
...
flowchart LR
  OPS0003["OPS0003"]
  EXEC0007["EXEC0007"] --> OPS0003
```


## Links

- Machine source: [`cyborgs/OPS0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/OPS0003.yaml)
- Job role doc: [OPS0003](../../../job_roles/ga_general_administrative/ops0003.md)
