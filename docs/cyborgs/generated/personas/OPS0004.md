---
title: "OPS0004 (OPS0004)"
description: "Cyborg persona OPS0004 — PMO / Portfolio Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">PMO / Portfolio Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">OPS0004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Operations</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `OPS0004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/OPS0004.yaml`
...
The PMO / Portfolio Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The PMO / Portfolio Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Portfolio governance and cross-org delivery.
...
flowchart LR
  OPS0004["OPS0004"]
  EXEC0007["EXEC0007"] --> OPS0004
```


## Links

- Machine source: [`cyborgs/OPS0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/OPS0004.yaml)
- Job role doc: [OPS0004](../../../job_roles/ga_general_administrative/ops0004.md)
