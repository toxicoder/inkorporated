---
title: "VPPeople (PEOP0001)"
description: "Cyborg persona PEOP0001 — VPPeople"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">VPPeople</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP0001</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-hr">cyborg-hr</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP0001.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">HR Leadership</span><span class="chip chip-cap">Recruiting</span><span class="chip chip-cap">Culture Management</span><span class="chip chip-cap">Employee Lifecycle Management</span><span class="chip chip-cap">HR_LEADERSHIP</span><span class="chip chip-cap">RECRUITING</span><span class="chip chip-cap">CULTURE_MANAGEMENT</span><span class="chip chip-cap">EMPLOYEE_LIFECYCLE_MANAGEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">HUMAN_RESOURCES</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">RECRUITING</span><span class="chip chip-tag">CULTURE</span><span class="chip chip-tag">LIFECYCLE</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">HUMAN_RESOURCES</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">RECRUITING</span><span class="chip chip-tag">CULTURE</span><span class="chip chip-tag">LIFECYCLE</span></div>
...
flowchart LR
  PEOP0001["PEOP0001"]
  PEOP0002["PEOP0002"] --> PEOP0001
```


## Links

- Machine source: [`cyborgs/PEOP0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP0001.yaml)
- Job role doc: [PEOP0001](../../../job_roles/ga_general_administrative/peop0001.md)
