---
title: "DirPeople (PEOP0002)"
description: "Cyborg persona PEOP0002 — DirPeople"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DirPeople</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP0002</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-hr">cyborg-hr</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP0002.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">HR Leadership</span><span class="chip chip-cap">HRBP/Recruiter Management</span><span class="chip chip-cap">People Strategy Development</span><span class="chip chip-cap">Organizational Support</span><span class="chip chip-cap">HR_LEADERSHIP</span><span class="chip chip-cap">HRBP_RECRUITER_MANAGEMENT</span><span class="chip chip-cap">PEOPLE_STRATEGY_DEVELOPMENT</span><span class="chip chip-cap">ORGANIZATIONAL_SUPPORT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">HUMAN_RESOURCES</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">TEAM_MANAGEMENT</span><span class="chip chip-tag">ORGANIZATIONAL</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">SUPPORT</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">HUMAN_RESOURCES</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">TEAM_MANAGEMENT</span><span class="chip chip-tag">ORGANIZATIONAL</span></div>
...
flowchart LR
  PEOP0002["PEOP0002"]
  PEOP0002["PEOP0002"] --> PEOP0002
```


## Links

- Machine source: [`cyborgs/PEOP0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP0002.yaml)
- Job role doc: [PEOP0002](../../../job_roles/ga_general_administrative/peop0002.md)
