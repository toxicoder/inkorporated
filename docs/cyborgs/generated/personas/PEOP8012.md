---
title: "PEOP8012 (PEOP8012)"
description: "Cyborg persona PEOP8012 — Learning & Development Partner"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Learning &amp; Development Partner</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP8012</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP8012`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP8012.yaml`
...
The Learning &amp; Development Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Learning &amp; Development Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Learning programs and manager enablement.
...
## Identity & mission
The Learning & Development Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Learning programs and manager enablement.
...
flowchart LR
  PEOP8012["PEOP8012"]
  PEOP0002["PEOP0002"] --> PEOP8012
```


## Links

- Machine source: [`cyborgs/PEOP8012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP8012.yaml)
- Job role doc: [PEOP8012](../../../job_roles/ga_general_administrative/peop8012.md)
