---
title: "PEOP8013 (PEOP8013)"
description: "Cyborg persona PEOP8013 — Compensation & Benefits Partner"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Compensation &amp; Benefits Partner</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP8013</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP8013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP8013.yaml`
...
The Compensation &amp; Benefits Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Compensation &amp; Benefits Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Comp cycles, benefits design, and equity ops.
...
## Identity & mission
The Compensation & Benefits Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Comp cycles, benefits design, and equity ops.
...
flowchart LR
  PEOP8013["PEOP8013"]
  PEOP0002["PEOP0002"] --> PEOP8013
```


## Links

- Machine source: [`cyborgs/PEOP8013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP8013.yaml)
- Job role doc: [PEOP8013](../../../job_roles/ga_general_administrative/peop8013.md)
