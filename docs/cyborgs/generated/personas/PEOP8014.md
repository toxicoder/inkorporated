---
title: "PEOP8014 (PEOP8014)"
description: "Cyborg persona PEOP8014 — DEI Program Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DEI Program Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP8014</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP8014`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP8014.yaml`
...
The DEI Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The DEI Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Inclusion programs and measurable workforce goals.
...
## Identity & mission
The DEI Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Inclusion programs and measurable workforce goals.
...
flowchart LR
  PEOP8014["PEOP8014"]
  PEOP0002["PEOP0002"] --> PEOP8014
```


## Links

- Machine source: [`cyborgs/PEOP8014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP8014.yaml)
- Job role doc: [PEOP8014](../../../job_roles/ga_general_administrative/peop8014.md)
