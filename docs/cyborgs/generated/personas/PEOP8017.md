---
title: "PEOP8017 (PEOP8017)"
description: "Cyborg persona PEOP8017 — Benefits Administrator"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Benefits Administrator</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PEOP8017</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-ga">cyborg-ga</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">People</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PEOP8017`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PEOP8017.yaml`
...
The Benefits Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Benefits Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Benefits enrollment and vendor administration.
...
## Identity & mission
The Benefits Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Benefits enrollment and vendor administration.
...
flowchart LR
  PEOP8017["PEOP8017"]
  PEOP0002["PEOP0002"] --> PEOP8017
```


## Links

- Machine source: [`cyborgs/PEOP8017.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP8017.yaml)
- Job role doc: [PEOP8017](../../../job_roles/ga_general_administrative/peop8017.md)
