---
title: "ChiefOfStaff (PERS0001)"
description: "Cyborg persona PERS0001 — ChiefOfStaff"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">ChiefOfStaff</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0001</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0001.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Schedule Management</span><span class="chip chip-cap">Priority Setting</span><span class="chip chip-cap">Operations Coordination</span><span class="chip chip-cap">Personal Support</span><span class="chip chip-cap">SCHEDULE_MANAGEMENT</span><span class="chip chip-cap">PRIORITY_SETTING</span><span class="chip chip-cap">OPERATIONS_COORDINATION</span><span class="chip chip-cap">PERSONAL_SUPPORT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">OPERATIONS</span><span class="chip chip-tag">SCHEDULING</span><span class="chip chip-tag">COORDINATION</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">OPERATIONS</span><span class="chip chip-tag">SCHEDULING</span><span class="chip chip-tag">COORDINATION</span></div>
...
flowchart LR
  PERS0001["PERS0001"]
  EXEC0001["EXEC0001"] --> PERS0001
```


## Links

- Machine source: [`cyborgs/PERS0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0001.yaml)
- Job role doc: [PERS0001](../../../job_roles/personal_staff/pers0001.md)
