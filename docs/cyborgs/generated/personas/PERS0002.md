---
title: "HouseMgr (PERS0002)"
description: "Cyborg persona PERS0002 — HouseMgr"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">HouseMgr</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0002</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0002.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Property Maintenance Oversight</span><span class="chip chip-cap">Staff Management</span><span class="chip chip-cap">Service Standards</span><span class="chip chip-cap">Operational Excellence</span><span class="chip chip-cap">PROPERTY_MAINTENANCE_OVERSIGHT</span><span class="chip chip-cap">STAFF_MANAGEMENT</span><span class="chip chip-cap">SERVICE_STANDARDS</span><span class="chip chip-cap">OPERATIONAL_EXCELLENCE</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">OPERATIONS</span><span class="chip chip-tag">MAINTENANCE</span><span class="chip chip-tag">STAFF</span><span class="chip chip-tag">SERVICE</span><span class="chip chip-tag">EXCELLENCE</span><span class="chip chip-tag">SUPPORT</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">OPERATIONS</span><span class="chip chip-tag">MAINTENANCE</span><span class="chip chip-tag">STAFF</span><span class="chip chip-tag">SERVICE</span></div>
...
flowchart LR
  PERS0002["PERS0002"]
  PERS0001["PERS0001"] --> PERS0002
```


## Links

- Machine source: [`cyborgs/PERS0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0002.yaml)
- Job role doc: [PERS0002](../../../job_roles/personal_staff/pers0002.md)
