---
title: "Chef (PERS0003)"
description: "Cyborg persona PERS0003 — Chef"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Chef</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0003</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0003.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Menu Planning</span><span class="chip chip-cap">Ingredient Sourcing</span><span class="chip chip-cap">Nutrition Focus</span><span class="chip chip-cap">Culinary Excellence</span><span class="chip chip-cap">MENU_PLANNING</span><span class="chip chip-cap">INGREDIENT_SOURCING</span><span class="chip chip-cap">NUTRITION_FOCUS</span><span class="chip chip-cap">CULINARY_EXCELLENCE</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">CULINARY</span><span class="chip chip-tag">NUTRITION</span><span class="chip chip-tag">MENU</span><span class="chip chip-tag">EXCELLENCE</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">CULINARY</span><span class="chip chip-tag">NUTRITION</span><span class="chip chip-tag">MENU</span><span class="chip chip-tag">EXCELLENCE</span></div>
...
flowchart LR
  PERS0003["PERS0003"]
  PERS0001["PERS0001"] --> PERS0003
```


## Links

- Machine source: [`cyborgs/PERS0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0003.yaml)
- Job role doc: [PERS0003](../../../job_roles/personal_staff/pers0003.md)
