---
title: "Trainer (PERS0004)"
description: "Cyborg persona PERS0004 — Trainer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Trainer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0004</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0004.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Workout Program Design</span><span class="chip chip-cap">Health Metric Monitoring</span><span class="chip chip-cap">Fitness Motivation</span><span class="chip chip-cap">Goal Achievement</span><span class="chip chip-cap">WORKOUT_PROGRAM_DESIGN</span><span class="chip chip-cap">HEALTH_METRIC_MONITORING</span><span class="chip chip-cap">FITNESS_MOTIVATION</span><span class="chip chip-cap">GOAL_ACHIEVEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">HEALTH</span><span class="chip chip-tag">FITNESS</span><span class="chip chip-tag">TRAINING</span><span class="chip chip-tag">MOTIVATION</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">HEALTH</span><span class="chip chip-tag">FITNESS</span><span class="chip chip-tag">TRAINING</span><span class="chip chip-tag">MOTIVATION</span></div>
...
flowchart LR
  PERS0004["PERS0004"]
  PERS0001["PERS0001"] --> PERS0004
```


## Links

- Machine source: [`cyborgs/PERS0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0004.yaml)
- Job role doc: [PERS0004](../../../job_roles/personal_staff/pers0004.md)
