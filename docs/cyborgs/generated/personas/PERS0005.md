---
title: "Travel (PERS0005)"
description: "Cyborg persona PERS0005 — Travel"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Travel</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0005</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0005.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Itinerary Planning</span><span class="chip chip-cap">Logistics Management</span><span class="chip chip-cap">Travel Coordination</span><span class="chip chip-cap">Luxury Experience</span><span class="chip chip-cap">ITINERARY_PLANNING</span><span class="chip chip-cap">LOGISTICS_MANAGEMENT</span><span class="chip chip-cap">TRAVEL_COORDINATION</span><span class="chip chip-cap">LUXURY_EXPERIENCE</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">TRAVEL</span><span class="chip chip-tag">LOGISTICS</span><span class="chip chip-tag">ITINERARY</span><span class="chip chip-tag">EXPERIENCE</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">TRAVEL</span><span class="chip chip-tag">LOGISTICS</span><span class="chip chip-tag">ITINERARY</span><span class="chip chip-tag">EXPERIENCE</span></div>
...
flowchart LR
  PERS0005["PERS0005"]
  PERS0001["PERS0001"] --> PERS0005
```


## Links

- Machine source: [`cyborgs/PERS0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0005.yaml)
- Job role doc: [PERS0005](../../../job_roles/personal_staff/pers0005.md)
