---
title: "Event (PERS0006)"
description: "Cyborg persona PERS0006 — Event"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Event</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0006</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0006.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Event Planning</span><span class="chip chip-cap">Vendor Management</span><span class="chip chip-cap">Guest List Coordination</span><span class="chip chip-cap">Occasion Execution</span><span class="chip chip-cap">EVENT_PLANNING</span><span class="chip chip-cap">VENDOR_MANAGEMENT</span><span class="chip chip-cap">GUEST_LIST_COORDINATION</span><span class="chip chip-cap">OCCASION_EXECUTION</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">EVENTS</span><span class="chip chip-tag">COORDINATION</span><span class="chip chip-tag">VENDORS</span><span class="chip chip-tag">GUESTS</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">SUPPORT</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">EVENTS</span><span class="chip chip-tag">COORDINATION</span><span class="chip chip-tag">VENDORS</span><span class="chip chip-tag">GUESTS</span></div>
...
flowchart LR
  PERS0006["PERS0006"]
  PERS0001["PERS0001"] --> PERS0006
```


## Links

- Machine source: [`cyborgs/PERS0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0006.yaml)
- Job role doc: [PERS0006](../../../job_roles/personal_staff/pers0006.md)
