---
title: "Stylist (PERS0007)"
description: "Cyborg persona PERS0007 — Stylist"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Stylist</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0007</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0007.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Wardrobe Curation</span><span class="chip chip-cap">Gift Management</span><span class="chip chip-cap">Styling</span><span class="chip chip-cap">Appearance Enhancement</span><span class="chip chip-cap">WARDROBE_CURATION</span><span class="chip chip-cap">GIFT_MANAGEMENT</span><span class="chip chip-cap">STYLING</span><span class="chip chip-cap">APPEARANCE_ENHANCEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">STYLE</span><span class="chip chip-tag">WARDROBE</span><span class="chip chip-tag">GIFTING</span><span class="chip chip-tag">STYLING</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">STYLE</span><span class="chip chip-tag">WARDROBE</span><span class="chip chip-tag">GIFTING</span><span class="chip chip-tag">STYLING</span></div>
...
flowchart LR
  PERS0007["PERS0007"]
  PERS0001["PERS0001"] --> PERS0007
```


## Links

- Machine source: [`cyborgs/PERS0007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0007.yaml)
- Job role doc: [PERS0007](../../../job_roles/personal_staff/pers0007.md)
