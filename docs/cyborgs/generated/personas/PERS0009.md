---
title: "Security (PERS0009)"
description: "Cyborg persona PERS0009 — Security"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Security</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0009</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0009`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0009.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Risk Assessment</span><span class="chip chip-cap">Close Protection</span><span class="chip chip-cap">Physical Safety</span><span class="chip chip-cap">Digital Security</span><span class="chip chip-cap">RISK_ASSESSMENT</span><span class="chip chip-cap">CLOSE_PROTECTION</span><span class="chip chip-cap">PHYSICAL_SAFETY</span><span class="chip chip-cap">DIGITAL_SECURITY</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SECURITY</span><span class="chip chip-tag">PROTECTION</span><span class="chip chip-tag">SAFETY</span><span class="chip chip-tag">RISK</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SECURITY</span><span class="chip chip-tag">PROTECTION</span><span class="chip chip-tag">SAFETY</span><span class="chip chip-tag">RISK</span></div>
...
flowchart LR
  PERS0009["PERS0009"]
  PERS0001["PERS0001"] --> PERS0009
```


## Links

- Machine source: [`cyborgs/PERS0009.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0009.yaml)
- Job role doc: [PERS0009](../../../job_roles/personal_staff/pers0009.md)
