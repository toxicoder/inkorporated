---
title: "CFO_Personal (PERS0010)"
description: "Cyborg persona PERS0010 — CFO_Personal"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">CFO_Personal</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0010</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0010.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Investment Strategy</span><span class="chip chip-cap">Tax Planning</span><span class="chip chip-cap">Estate Management</span><span class="chip chip-cap">Wealth Preservation</span><span class="chip chip-cap">INVESTMENT_STRATEGY</span><span class="chip chip-cap">TAX_PLANNING</span><span class="chip chip-cap">ESTATE_MANAGEMENT</span><span class="chip chip-cap">WEALTH_PRESERVATION</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">FINANCE</span><span class="chip chip-tag">INVESTMENTS</span><span class="chip chip-tag">TAX</span><span class="chip chip-tag">ESTATE</span><span class="chip chip-tag">WEALTH</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">FINANCE</span><span class="chip chip-tag">INVESTMENTS</span><span class="chip chip-tag">TAX</span><span class="chip chip-tag">ESTATE</span></div>
...
flowchart LR
  PERS0010["PERS0010"]
  PERS0001["PERS0001"] --> PERS0010
```


## Links

- Machine source: [`cyborgs/PERS0010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0010.yaml)
- Job role doc: [PERS0010](../../../job_roles/personal_staff/pers0010.md)
