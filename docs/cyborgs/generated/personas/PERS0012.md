---
title: "Doctor (PERS0012)"
description: "Cyborg persona PERS0012 — Doctor"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Doctor</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0012</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0012`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0012.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Health Coordination</span><span class="chip chip-cap">Longevity Strategies</span><span class="chip chip-cap">Medical Access</span><span class="chip chip-cap">Holistic Care</span><span class="chip chip-cap">HEALTH_COORDINATION</span><span class="chip chip-cap">LONGEVITY_STRATEGIES</span><span class="chip chip-cap">MEDICAL_ACCESS</span><span class="chip chip-cap">HOLISTIC_CARE</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">HEALTH</span><span class="chip chip-tag">MEDICAL</span><span class="chip chip-tag">LONGEVITY</span><span class="chip chip-tag">CARE</span><span class="chip chip-tag">SUPPORT</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">HEALTH</span><span class="chip chip-tag">MEDICAL</span><span class="chip chip-tag">LONGEVITY</span><span class="chip chip-tag">CARE</span></div>
...
flowchart LR
  PERS0012["PERS0012"]
  PERS0001["PERS0001"] --> PERS0012
```


## Links

- Machine source: [`cyborgs/PERS0012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0012.yaml)
- Job role doc: [PERS0012](../../../job_roles/personal_staff/pers0012.md)
