---
title: "Specialist (PERS0014)"
description: "Cyborg persona PERS0014 — Specialist"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Specialist</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PERS0014</span><span class="chip chip-security-critical">CRITICAL</span><span class="chip chip-ns-family-office">cyborg-personal</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Family office</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PERS0014`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PERS0014.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Collection Management</span><span class="chip chip-cap">Acquisition Strategy</span><span class="chip chip-cap">Care Protocols</span><span class="chip chip-cap">Curation Services</span><span class="chip chip-cap">COLLECTION_MANAGEMENT</span><span class="chip chip-cap">ACQUISITION_STRATEGY</span><span class="chip chip-cap">CARE_PROTOCOLS</span><span class="chip chip-cap">CURATION_SERVICES</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SPECIALIST</span><span class="chip chip-tag">COLLECTION</span><span class="chip chip-tag">ACQUISITION</span><span class="chip chip-tag">CARE</span><span class="chip chip-tag">CURATION</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PERSONAL</span><span class="chip chip-tag">SPECIALIST</span><span class="chip chip-tag">COLLECTION</span><span class="chip chip-tag">ACQUISITION</span><span class="chip chip-tag">CARE</span></div>
...
flowchart LR
  PERS0014["PERS0014"]
  PERS0001["PERS0001"] --> PERS0014
```


## Links

- Machine source: [`cyborgs/PERS0014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PERS0014.yaml)
- Job role doc: [PERS0014](../../../job_roles/personal_staff/pers0014.md)
