---
title: "VPProduct (PROD0001)"
description: "Cyborg persona PROD0001 — VPProduct"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">VPProduct</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PROD0001</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-product</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Product</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PROD0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PROD0001.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Product Strategy Execution</span><span class="chip chip-cap">Roadmap Management</span><span class="chip chip-cap">Team Management</span><span class="chip chip-cap">Cross-Functional Alignment</span><span class="chip chip-cap">PRODUCT_STRATEGY_EXECUTION</span><span class="chip chip-cap">ROADMAP_MANAGEMENT</span><span class="chip chip-cap">TEAM_MANAGEMENT</span><span class="chip chip-cap">CROSS_FUNCTIONAL_ALIGNMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PRODUCT</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">ALIGNMENT</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">VISIONARY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PRODUCT</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">ALIGNMENT</span></div>
...
flowchart LR
  PROD0001["PROD0001"]
  PROD0002["PROD0002"] --> PROD0001
```


## Links

- Machine source: [`cyborgs/PROD0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD0001.yaml)
- Job role doc: [PROD0001](../../../job_roles/product_design/prod0001.md)
