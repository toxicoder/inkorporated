---
title: "GroupPM (PROD0003)"
description: "Cyborg persona PROD0003 — GroupPM"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">GroupPM</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PROD0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-product</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Product</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PROD0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PROD0003.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Product Area Leadership</span><span class="chip chip-cap">PM Management</span><span class="chip chip-cap">Strategy-Execution Bridge</span><span class="chip chip-cap">Team Coordination</span><span class="chip chip-cap">PRODUCT_AREA_LEADERSHIP</span><span class="chip chip-cap">PM_MANAGEMENT</span><span class="chip chip-cap">STRATEGY_EXECUTION_BRIDGE</span><span class="chip chip-cap">TEAM_COORDINATION</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PRODUCT</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">ALIGNMENT</span><span class="chip chip-tag">COORDINATION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">PRODUCT</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">TEAM_LEAD</span></div>
...
flowchart LR
  PROD0003["PROD0003"]
  PROD0002["PROD0002"] --> PROD0003
```


## Links

- Machine source: [`cyborgs/PROD0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD0003.yaml)
- Job role doc: [PROD0003](../../../job_roles/product_design/prod0003.md)
