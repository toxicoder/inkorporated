---
title: "PROD2003 (PROD2003)"
description: "Cyborg persona PROD2003 — Growth Product Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Growth Product Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PROD2003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Product</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PROD2003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PROD2003.yaml`
...
## Identity & mission
The Growth Product Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns acquisition, activation, and retention product loops.
...
flowchart LR
  PROD2003["PROD2003"]
  PROD0002["PROD0002"] --> PROD2003
```


## Links

- Machine source: [`cyborgs/PROD2003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD2003.yaml)
- Job role doc: [PROD2003](../../../job_roles/product_design/prod2003.md)
