---
title: "PROD2004 (PROD2004)"
description: "Cyborg persona PROD2004 — Platform Product Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Platform Product Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">PROD2004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Product</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `PROD2004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/PROD2004.yaml`
...
The Platform Product Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Platform Product Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns internal platform product outcomes.
...
flowchart LR
  PROD2004["PROD2004"]
  PROD0002["PROD0002"] --> PROD2004
```


## Links

- Machine source: [`cyborgs/PROD2004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD2004.yaml)
- Job role doc: [PROD2004](../../../job_roles/product_design/prod2004.md)
