---
title: "Regional (REGN0002)"
description: "Cyborg persona REGN0002 — Regional GM, EMEA"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Regional GM, EMEA</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">REGN0002</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Regional</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `REGN0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/REGN0002.yaml`
...
The Regional GM, EMEA at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Regional GM, EMEA at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns EMEA regional outcomes and partner ecosystem.
...
## Identity & mission
The Regional GM, EMEA at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns EMEA regional outcomes and partner ecosystem.
...
flowchart LR
  REGN0002["REGN0002"]
  EXEC0004["EXEC0004"] --> REGN0002
```


## Links

- Machine source: [`cyborgs/REGN0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/REGN0002.yaml)
- Job role doc: [REGN0002](../../../job_roles/regional_operations/regn0002.md)
