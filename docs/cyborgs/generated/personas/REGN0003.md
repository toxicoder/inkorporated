---
title: "Regional (REGN0003)"
description: "Cyborg persona REGN0003 — Regional GM, APAC"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Regional GM, APAC</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">REGN0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Regional</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `REGN0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/REGN0003.yaml`
...
The Regional GM, APAC at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Regional GM, APAC at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns APAC regional outcomes and market expansion.
...
## Identity & mission
The Regional GM, APAC at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns APAC regional outcomes and market expansion.
...
flowchart LR
  REGN0003["REGN0003"]
  EXEC0004["EXEC0004"] --> REGN0003
```


## Links

- Machine source: [`cyborgs/REGN0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/REGN0003.yaml)
- Job role doc: [REGN0003](../../../job_roles/regional_operations/regn0003.md)
