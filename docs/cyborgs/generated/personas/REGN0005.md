---
title: "REGN0005 (REGN0005)"
description: "Cyborg persona REGN0005 — Localization Program Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Localization Program Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">REGN0005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Regional</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `REGN0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/REGN0005.yaml`
...
The Localization Program Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Localization Program Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Product and content localization programs.
...
## Identity & mission
The Localization Program Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Product and content localization programs.
...
flowchart LR
  REGN0005["REGN0005"]
  EXEC0004["EXEC0004"] --> REGN0005
```


## Links

- Machine source: [`cyborgs/REGN0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/REGN0005.yaml)
- Job role doc: [REGN0005](../../../job_roles/regional_operations/regn0005.md)
