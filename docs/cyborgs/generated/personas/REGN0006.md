---
title: "REGN0006 (REGN0006)"
description: "Cyborg persona REGN0006 — Regional Finance Partner"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Regional Finance Partner</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">REGN0006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Regional</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `REGN0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/REGN0006.yaml`
...
The Regional Finance Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Regional Finance Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Regional FP&amp;A partnership with dotted line to Finance.
...
## Identity & mission
The Regional Finance Partner at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Regional FP&A partnership with dotted line to Finance.
...
flowchart LR
  REGN0006["REGN0006"]
  EXEC0004["EXEC0004"] --> REGN0006
```


## Links

- Machine source: [`cyborgs/REGN0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/REGN0006.yaml)
- Job role doc: [REGN0006](../../../job_roles/regional_operations/regn0006.md)
