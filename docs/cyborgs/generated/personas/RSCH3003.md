---
title: "RSCH3003 (RSCH3003)"
description: "Cyborg persona RSCH3003 — Research Operations"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Research Operations</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">RSCH3003</span><span class="chip chip-security-medium">MEDIUM</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Research</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `RSCH3003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/RSCH3003.yaml`
...
The Research Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Research Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Scales research quality, panels, and insights ops.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">Methodologist</span><span class="chip chip-tag">Synthesizer</span><span class="chip chip-tag">Ethics Sentinel</span><span class="chip chip-tag">Partner</span></div>
...
## Identity & mission
The Research Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Scales research quality, panels, and insights ops.
...
flowchart LR
  RSCH3003["RSCH3003"]
  DESN0001["DESN0001"] --> RSCH3003
```


## Links

- Machine source: [`cyborgs/RSCH3003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/RSCH3003.yaml)
- Job role doc: [RSCH3003](../../../job_roles/product_design/rsch3003.md)
