---
title: "VPSales (SALE0001)"
description: "Cyborg persona SALE0001 — VPSales"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">VPSales</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE0001</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-default">cyborg-sales</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE0001.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Sales Leadership</span><span class="chip chip-cap">Revenue Generation</span><span class="chip chip-cap">Strategy Setting</span><span class="chip chip-cap">Pipeline Management</span><span class="chip chip-cap">SALES_LEADERSHIP</span><span class="chip chip-cap">REVENUE_GENERATION</span><span class="chip chip-cap">STRATEGY_SETTING</span><span class="chip chip-cap">PIPELINE_MANAGEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">REVENUE</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">PIPELINE</span><span class="chip chip-tag">EXECUTIVE</span><span class="chip chip-tag">PERFORMANCE</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">REVENUE</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">STRATEGY</span><span class="chip chip-tag">PIPELINE</span></div>
...
flowchart LR
  SALE0001["SALE0001"]
  SALE0003["SALE0003"] --> SALE0001
```


## Links

- Machine source: [`cyborgs/SALE0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE0001.yaml)
- Job role doc: [SALE0001](../../../job_roles/go_to_market_sales_marketing/sale0001.md)
