---
title: "DirSales (SALE0002)"
description: "Cyborg persona SALE0002 — DirSales"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">DirSales</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE0002</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-default">cyborg-sales</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE0002.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Sales Region Leadership</span><span class="chip chip-cap">Manager Management</span><span class="chip chip-cap">Strategy Execution</span><span class="chip chip-cap">Performance Management</span><span class="chip chip-cap">SALES_REGION_LEADERSHIP</span><span class="chip chip-cap">MANAGER_MANAGEMENT</span><span class="chip chip-cap">STRATEGY_EXECUTION</span><span class="chip chip-cap">PERFORMANCE_MANAGEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">REGIONAL</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">PERFORMANCE</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">STRATEGY</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">REGIONAL</span><span class="chip chip-tag">LEADERSHIP</span><span class="chip chip-tag">EXECUTION</span><span class="chip chip-tag">PERFORMANCE</span></div>
...
flowchart LR
  SALE0002["SALE0002"]
  SALE0003["SALE0003"] --> SALE0002
```


## Links

- Machine source: [`cyborgs/SALE0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE0002.yaml)
- Job role doc: [SALE0002](../../../job_roles/go_to_market_sales_marketing/sale0002.md)
