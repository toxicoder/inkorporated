---
title: "SalesMgr (SALE0003)"
description: "Cyborg persona SALE0003 — SalesMgr"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">SalesMgr</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-default">cyborg-sales</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE0003.yaml`
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-cap">Team Coaching</span><span class="chip chip-cap">Pipeline Development</span><span class="chip chip-cap">Deal Closure</span><span class="chip chip-cap">Performance Management</span><span class="chip chip-cap">TEAM_COACHING</span><span class="chip chip-cap">PIPELINE_DEVELOPMENT</span><span class="chip chip-cap">DEAL_CLOSURE</span><span class="chip chip-cap">PERFORMANCE_MANAGEMENT</span></div>
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">PIPELINE</span><span class="chip chip-tag">DEALS</span><span class="chip chip-tag">COACHING</span><span class="chip chip-tag">PERFORMANCE</span><span class="chip chip-tag">EXECUTION</span></div>
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">SALES</span><span class="chip chip-tag">TEAM_LEAD</span><span class="chip chip-tag">PIPELINE</span><span class="chip chip-tag">DEALS</span><span class="chip chip-tag">COACHING</span></div>
...
flowchart LR
  SALE0003["SALE0003"]
  SALE0003["SALE0003"] --> SALE0003
```


## Links

- Machine source: [`cyborgs/SALE0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE0003.yaml)
- Job role doc: [SALE0003](../../../job_roles/go_to_market_sales_marketing/sale0003.md)
