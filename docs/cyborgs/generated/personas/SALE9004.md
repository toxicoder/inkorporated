---
title: "SALE9004 (SALE9004)"
description: "Cyborg persona SALE9004 — Enterprise Account Executive"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Enterprise Account Executive</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE9004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE9004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE9004.yaml`
...
The Enterprise Account Executive at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Enterprise Account Executive at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns complex enterprise deals and multi-thread selling.
...
flowchart LR
  SALE9004["SALE9004"]
  SALE0003["SALE0003"] --> SALE9004
```


## Links

- Machine source: [`cyborgs/SALE9004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9004.yaml)
- Job role doc: [SALE9004](../../../job_roles/go_to_market_sales_marketing/sale9004.md)
