---
title: "SALE9005 (SALE9005)"
description: "Cyborg persona SALE9005 — Channel Partner Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Channel Partner Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE9005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE9005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE9005.yaml`
...
The Channel Partner Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Channel Partner Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and enables partner-sourced revenue.
...
## Identity & mission
The Channel Partner Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and enables partner-sourced revenue.
...
flowchart LR
  SALE9005["SALE9005"]
  SALE0003["SALE0003"] --> SALE9005
```


## Links

- Machine source: [`cyborgs/SALE9005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9005.yaml)
- Job role doc: [SALE9005](../../../job_roles/go_to_market_sales_marketing/sale9005.md)
