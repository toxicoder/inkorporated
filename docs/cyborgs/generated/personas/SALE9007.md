---
title: "SALE9007 (SALE9007)"
description: "Cyborg persona SALE9007 — Sales Enablement Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Sales Enablement Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE9007</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE9007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE9007.yaml`
...
The Sales Enablement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Sales Enablement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Training, content, and deal coaching systems.
...
## Identity & mission
The Sales Enablement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Training, content, and deal coaching systems.
...
flowchart LR
  SALE9007["SALE9007"]
  SALE0003["SALE0003"] --> SALE9007
```


## Links

- Machine source: [`cyborgs/SALE9007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9007.yaml)
- Job role doc: [SALE9007](../../../job_roles/go_to_market_sales_marketing/sale9007.md)
