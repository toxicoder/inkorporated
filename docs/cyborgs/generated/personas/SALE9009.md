---
title: "SALE9009 (SALE9009)"
description: "Cyborg persona SALE9009 — Sales Engineer II"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Sales Engineer II</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE9009</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE9009`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE9009.yaml`
...
The Sales Engineer II at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Sales Engineer II at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Technical discovery and demos for complex deals.
...
## Identity & mission
The Sales Engineer II at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Technical discovery and demos for complex deals.
...
flowchart LR
  SALE9009["SALE9009"]
  SALE0003["SALE0003"] --> SALE9009
```


## Links

- Machine source: [`cyborgs/SALE9009.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9009.yaml)
- Job role doc: [SALE9009](../../../job_roles/go_to_market_sales_marketing/sale9009.md)
