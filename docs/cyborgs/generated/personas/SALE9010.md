---
title: "Revenue (SALE9010)"
description: "Cyborg persona SALE9010 — Revenue Operations"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Revenue Operations</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SALE9010</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-gtm">cyborg-gtm</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Sales</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SALE9010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SALE9010.yaml`
...
The Revenue Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Revenue Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns GTM systems, funnel metrics, and operating cadence.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">SALE</span></div>
...
## Identity & mission
The Revenue Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns GTM systems, funnel metrics, and operating cadence.
...
flowchart LR
  SALE9010["SALE9010"]
  SALE0003["SALE0003"] --> SALE9010
```


## Links

- Machine source: [`cyborgs/SALE9010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9010.yaml)
- Job role doc: [SALE9010](../../../job_roles/go_to_market_sales_marketing/sale9010.md)
