---
title: "SQAD0001 (SQAD0001)"
description: "Cyborg persona SQAD0001 — Incident Command Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Incident Command Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0001</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0001`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0001.yaml`
...
The Incident Command Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Incident Command Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Coordinates major incident response across functions.
...
flowchart LR
  SQAD0001["SQAD0001"]
  PROD0001["PROD0001"] --> SQAD0001
```


## Links

- Machine source: [`cyborgs/SQAD0001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0001.yaml)
- Job role doc: [SQAD0001](../../../job_roles/specialized_squads_cross_functional_teams/sqad0001.md)
