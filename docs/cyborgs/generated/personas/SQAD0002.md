---
title: "SQAD0002 (SQAD0002)"
description: "Cyborg persona SQAD0002 — Platform Foundations Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Platform Foundations Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0002</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0002`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0002.yaml`
...
flowchart LR
  SQAD0002["SQAD0002"]
  PROD0001["PROD0001"] --> SQAD0002
```


## Links

- Machine source: [`cyborgs/SQAD0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0002.yaml)
- Job role doc: [SQAD0002](../../../job_roles/specialized_squads_cross_functional_teams/sqad0002.md)
