---
title: "SQAD0003 (SQAD0003)"
description: "Cyborg persona SQAD0003 — AI Product Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">AI Product Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0003</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0003`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0003.yaml`
...
The AI Product Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The AI Product Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships AI product capabilities with safety reviews.
...
flowchart LR
  SQAD0003["SQAD0003"]
  PROD0001["PROD0001"] --> SQAD0003
```


## Links

- Machine source: [`cyborgs/SQAD0003.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0003.yaml)
- Job role doc: [SQAD0003](../../../job_roles/specialized_squads_cross_functional_teams/sqad0003.md)
