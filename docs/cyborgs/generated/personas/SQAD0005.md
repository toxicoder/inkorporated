---
title: "SQAD0005 (SQAD0005)"
description: "Cyborg persona SQAD0005 — Trust & Safety Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Trust &amp; Safety Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0005.yaml`
...
The Trust &amp; Safety Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Trust &amp; Safety Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns abuse prevention and trust systems.
...
flowchart LR
  SQAD0005["SQAD0005"]
  PROD0001["PROD0001"] --> SQAD0005
```


## Links

- Machine source: [`cyborgs/SQAD0005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0005.yaml)
- Job role doc: [SQAD0005](../../../job_roles/specialized_squads_cross_functional_teams/sqad0005.md)
