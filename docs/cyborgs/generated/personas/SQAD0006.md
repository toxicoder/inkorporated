---
title: "SQAD0006 (SQAD0006)"
description: "Cyborg persona SQAD0006 — M&A Integration Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">M&amp;A Integration Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0006.yaml`
...
The M&amp;A Integration Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The M&amp;A Integration Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Integrates acquisitions technically and operationally.
...
flowchart LR
  SQAD0006["SQAD0006"]
  PROD0001["PROD0001"] --> SQAD0006
```


## Links

- Machine source: [`cyborgs/SQAD0006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0006.yaml)
- Job role doc: [SQAD0006](../../../job_roles/specialized_squads_cross_functional_teams/sqad0006.md)
