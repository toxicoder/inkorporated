---
title: "SQAD0007 (SQAD0007)"
description: "Cyborg persona SQAD0007 — Open Source Program Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Open Source Program Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0007</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0007`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0007.yaml`
...
The Open Source Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Open Source Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Governs open source usage and contributions.
...
flowchart LR
  SQAD0007["SQAD0007"]
  PROD0001["PROD0001"] --> SQAD0007
```


## Links

- Machine source: [`cyborgs/SQAD0007.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0007.yaml)
- Job role doc: [SQAD0007](../../../job_roles/specialized_squads_cross_functional_teams/sqad0007.md)
