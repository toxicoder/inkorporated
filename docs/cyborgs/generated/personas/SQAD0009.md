---
title: "SQAD0009 (SQAD0009)"
description: "Cyborg persona SQAD0009 — Data Platform Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Data Platform Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0009</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0009`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0009.yaml`
...
The Data Platform Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Data Platform Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Data platform delivery and self-serve analytics infrastructure.
...
flowchart LR
  SQAD0009["SQAD0009"]
  PROD0001["PROD0001"] --> SQAD0009
```


## Links

- Machine source: [`cyborgs/SQAD0009.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0009.yaml)
- Job role doc: [SQAD0009](../../../job_roles/specialized_squads_cross_functional_teams/sqad0009.md)
