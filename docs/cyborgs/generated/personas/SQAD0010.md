---
title: "SQAD0010 (SQAD0010)"
description: "Cyborg persona SQAD0010 — Enterprise Readiness Squad Lead"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Enterprise Readiness Squad Lead</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SQAD0010</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-squad">cyborg-squad</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Squad lead</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SQAD0010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SQAD0010.yaml`
...
The Enterprise Readiness Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Enterprise Readiness Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Enterprise feature completeness and launch gates.
...
flowchart LR
  SQAD0010["SQAD0010"]
  PROD0001["PROD0001"] --> SQAD0010
```


## Links

- Machine source: [`cyborgs/SQAD0010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0010.yaml)
- Job role doc: [SQAD0010](../../../job_roles/specialized_squads_cross_functional_teams/sqad0010.md)
