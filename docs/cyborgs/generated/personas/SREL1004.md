---
title: "SecOps_Guardian (SREL1004)"
description: "Cyborg persona SREL1004 — SecOps_Guardian"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    ...
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1004</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1004`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1004.yaml`
...
flowchart LR
  SREL1004["SREL1004"]
  SREL0003["SREL0003"] --> SREL1004
```


## Links

- Machine source: [`cyborgs/SREL1004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1004.yaml)
- Job role doc: [SREL1004](../../../job_roles/security_risk/srel1004.md)
