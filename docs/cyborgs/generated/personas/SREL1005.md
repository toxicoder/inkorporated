---
title: "Application (SREL1005)"
description: "Cyborg persona SREL1005 — Application Security Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Application Security Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1005</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1005`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1005.yaml`
...
The Application Security Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Application Security Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Embeds security in SDLC; threat models, reviews, and secure defaults.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">SREL</span></div>
...
flowchart LR
  SREL1005["SREL1005"]
  SREL0003["SREL0003"] --> SREL1005
```


## Links

- Machine source: [`cyborgs/SREL1005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1005.yaml)
- Job role doc: [SREL1005](../../../job_roles/security_risk/srel1005.md)
