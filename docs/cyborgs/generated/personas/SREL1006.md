---
title: "SOC (SREL1006)"
description: "Cyborg persona SREL1006 — SOC Analyst"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">SOC Analyst</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1006</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1006`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1006.yaml`
...
The SOC Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The SOC Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Detects and triages security events; drives incident containment.
...
flowchart LR
  SREL1006["SREL1006"]
  SREL0003["SREL0003"] --> SREL1006
```


## Links

- Machine source: [`cyborgs/SREL1006.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1006.yaml)
- Job role doc: [SREL1006](../../../job_roles/security_risk/srel1006.md)
