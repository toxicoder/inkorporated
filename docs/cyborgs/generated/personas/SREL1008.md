---
title: "SREL1008 (SREL1008)"
description: "Cyborg persona SREL1008 — Security Architect"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Security Architect</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1008</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1008`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1008.yaml`
...
The Security Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Security Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs security architecture and control patterns.
...
flowchart LR
  SREL1008["SREL1008"]
  SREL0003["SREL0003"] --> SREL1008
```


## Links

- Machine source: [`cyborgs/SREL1008.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1008.yaml)
- Job role doc: [SREL1008](../../../job_roles/security_risk/srel1008.md)
