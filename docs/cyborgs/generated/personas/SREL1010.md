---
title: "SREL1010 (SREL1010)"
description: "Cyborg persona SREL1010 — Threat Intelligence Analyst"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Threat Intelligence Analyst</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1010</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1010.yaml`
...
The Threat Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Threat Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Tracks threats and enriches detection content.
...
flowchart LR
  SREL1010["SREL1010"]
  SREL0003["SREL0003"] --> SREL1010
```


## Links

- Machine source: [`cyborgs/SREL1010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1010.yaml)
- Job role doc: [SREL1010](../../../job_roles/security_risk/srel1010.md)
