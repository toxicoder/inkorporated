---
title: "SREL1011 (SREL1011)"
description: "Cyborg persona SREL1011 — Privacy Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Privacy Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1011</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1011`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1011.yaml`
...
The Privacy Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Privacy Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Implements privacy-by-design technical controls.
...
flowchart LR
  SREL1011["SREL1011"]
  SREL0003["SREL0003"] --> SREL1011
```


## Links

- Machine source: [`cyborgs/SREL1011.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1011.yaml)
- Job role doc: [SREL1011](../../../job_roles/security_risk/srel1011.md)
