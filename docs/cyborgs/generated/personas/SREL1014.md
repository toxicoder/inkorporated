---
title: "SREL1014 (SREL1014)"
description: "Cyborg persona SREL1014 — Detection Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Detection Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1014</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1014`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1014.yaml`
...
The Detection Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Detection Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Authors high-signal detections and response playbooks.
...
flowchart LR
  SREL1014["SREL1014"]
  SREL0003["SREL0003"] --> SREL1014
```


## Links

- Machine source: [`cyborgs/SREL1014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1014.yaml)
- Job role doc: [SREL1014](../../../job_roles/security_risk/srel1014.md)
