---
title: "SREL1015 (SREL1015)"
description: "Cyborg persona SREL1015 — SRE Manager"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">SRE Manager</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SREL1015</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-security">cyborg-security</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Reliability &amp; security eng</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SREL1015`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SREL1015.yaml`
...
The SRE Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The SRE Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. People leadership for reliability engineers.
...
flowchart LR
  SREL1015["SREL1015"]
  SREL0003["SREL0003"] --> SREL1015
```


## Links

- Machine source: [`cyborgs/SREL1015.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1015.yaml)
- Job role doc: [SREL1015](../../../job_roles/security_risk/srel1015.md)
