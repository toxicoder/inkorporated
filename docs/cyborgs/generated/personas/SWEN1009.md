---
title: "ML (SWEN1009)"
description: "Cyborg persona SWEN1009 — ML Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">ML Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1009</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1009`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1009.yaml`
...
The ML Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The ML Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships production ML systems with reliability and evaluation discipline.
...
flowchart LR
  SWEN1009["SWEN1009"]
  SWEN0005["SWEN0005"] --> SWEN1009
```


## Links

- Machine source: [`cyborgs/SWEN1009.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1009.yaml)
- Job role doc: [SWEN1009](../../../job_roles/engineering_technology/swen1009.md)
