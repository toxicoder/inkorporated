---
title: "Technical (SWEN1010)"
description: "Cyborg persona SWEN1010 — Technical Writer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Technical Writer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1010</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1010`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1010.yaml`
...
The Technical Writer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Technical Writer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Creates developer and operator documentation that stays accurate.
...
<div class="cyborg-chip-row" markdown="0"><span class="chip chip-tag">ENTERPRISE</span><span class="chip chip-tag">SWEN</span></div>
...
## Identity & mission
The Technical Writer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Creates developer and operator documentation that stays accurate.
...
flowchart LR
  SWEN1010["SWEN1010"]
  SWEN0005["SWEN0005"] --> SWEN1010
```


## Links

- Machine source: [`cyborgs/SWEN1010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1010.yaml)
- Job role doc: [SWEN1010](../../../job_roles/engineering_technology/swen1010.md)
