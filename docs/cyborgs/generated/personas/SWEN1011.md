---
title: "SWEN1011 (SWEN1011)"
description: "Cyborg persona SWEN1011 — Principal Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Principal Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1011</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1011`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1011.yaml`
...
flowchart LR
  SWEN1011["SWEN1011"]
  SWEN0005["SWEN0005"] --> SWEN1011
```


## Links

- Machine source: [`cyborgs/SWEN1011.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1011.yaml)
- Job role doc: [SWEN1011](../../../job_roles/engineering_technology/swen1011.md)
