---
title: "SWEN1012 (SWEN1012)"
description: "Cyborg persona SWEN1012 — Developer Advocate"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Developer Advocate</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1012</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1012`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1012.yaml`
...
The Developer Advocate at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Developer Advocate at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. External developer experience, samples, and community.
...
flowchart LR
  SWEN1012["SWEN1012"]
  SWEN0005["SWEN0005"] --> SWEN1012
```


## Links

- Machine source: [`cyborgs/SWEN1012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1012.yaml)
- Job role doc: [SWEN1012](../../../job_roles/engineering_technology/swen1012.md)
