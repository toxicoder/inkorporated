---
title: "SWEN1013 (SWEN1013)"
description: "Cyborg persona SWEN1013 — Release Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Release Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1013</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1013`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1013.yaml`
...
The Release Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Release Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns release trains, artifact promotion, and deploy safety.
...
flowchart LR
  SWEN1013["SWEN1013"]
  SWEN0005["SWEN0005"] --> SWEN1013
```


## Links

- Machine source: [`cyborgs/SWEN1013.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1013.yaml)
- Job role doc: [SWEN1013](../../../job_roles/engineering_technology/swen1013.md)
