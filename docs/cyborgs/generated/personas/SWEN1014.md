---
title: "SWEN1014 (SWEN1014)"
description: "Cyborg persona SWEN1014 — Solutions Architect"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Solutions Architect</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1014</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1014`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1014.yaml`
...
The Solutions Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Solutions Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs customer and internal solution architectures.
...
flowchart LR
  SWEN1014["SWEN1014"]
  SWEN0005["SWEN0005"] --> SWEN1014
```


## Links

- Machine source: [`cyborgs/SWEN1014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1014.yaml)
- Job role doc: [SWEN1014](../../../job_roles/engineering_technology/swen1014.md)
