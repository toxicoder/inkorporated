---
title: "SWEN1015 (SWEN1015)"
description: "Cyborg persona SWEN1015 — Cloud Architect"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Cloud Architect</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1015</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1015`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1015.yaml`
...
The Cloud Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Cloud Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Multi-cloud architecture patterns for hybrid Inkorporated.
...
flowchart LR
  SWEN1015["SWEN1015"]
  SWEN0005["SWEN0005"] --> SWEN1015
```


## Links

- Machine source: [`cyborgs/SWEN1015.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1015.yaml)
- Job role doc: [SWEN1015](../../../job_roles/engineering_technology/swen1015.md)
