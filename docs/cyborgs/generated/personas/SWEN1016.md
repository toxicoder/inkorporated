---
title: "SWEN1016 (SWEN1016)"
description: "Cyborg persona SWEN1016 — iOS Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">iOS Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1016</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1016`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1016.yaml`
...
The iOS Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The iOS Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native iOS applications.
...
flowchart LR
  SWEN1016["SWEN1016"]
  SWEN0005["SWEN0005"] --> SWEN1016
```


## Links

- Machine source: [`cyborgs/SWEN1016.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1016.yaml)
- Job role doc: [SWEN1016](../../../job_roles/engineering_technology/swen1016.md)
