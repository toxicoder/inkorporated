---
title: "SWEN1017 (SWEN1017)"
description: "Cyborg persona SWEN1017 — Android Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Android Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1017</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1017`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1017.yaml`
...
The Android Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Android Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native Android applications.
...
flowchart LR
  SWEN1017["SWEN1017"]
  SWEN0005["SWEN0005"] --> SWEN1017
```


## Links

- Machine source: [`cyborgs/SWEN1017.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1017.yaml)
- Job role doc: [SWEN1017](../../../job_roles/engineering_technology/swen1017.md)
