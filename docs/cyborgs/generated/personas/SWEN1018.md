---
title: "SWEN1018 (SWEN1018)"
description: "Cyborg persona SWEN1018 — Developer Experience Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Developer Experience Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1018</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1018`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1018.yaml`
...
The Developer Experience Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Developer Experience Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Improves CI, local dev, templates, and inner loop speed.
...
flowchart LR
  SWEN1018["SWEN1018"]
  SWEN0005["SWEN0005"] --> SWEN1018
```


## Links

- Machine source: [`cyborgs/SWEN1018.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1018.yaml)
- Job role doc: [SWEN1018](../../../job_roles/engineering_technology/swen1018.md)
