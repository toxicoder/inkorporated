---
title: "SWEN1020 (SWEN1020)"
description: "Cyborg persona SWEN1020 — Database Administrator"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Database Administrator</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1020</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1020`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1020.yaml`
...
The Database Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Database Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns database reliability, backups, and performance.
...
flowchart LR
  SWEN1020["SWEN1020"]
  SWEN0005["SWEN0005"] --> SWEN1020
```


## Links

- Machine source: [`cyborgs/SWEN1020.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1020.yaml)
- Job role doc: [SWEN1020](../../../job_roles/engineering_technology/swen1020.md)
