---
title: "SWEN1021 (SWEN1021)"
description: "Cyborg persona SWEN1021 — Build Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Build Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1021</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1021`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1021.yaml`
...
The Build Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Build Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns build systems, caches, and CI performance.
...
flowchart LR
  SWEN1021["SWEN1021"]
  SWEN0005["SWEN0005"] --> SWEN1021
```


## Links

- Machine source: [`cyborgs/SWEN1021.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1021.yaml)
- Job role doc: [SWEN1021](../../../job_roles/engineering_technology/swen1021.md)
