---
title: "SWEN1022 (SWEN1022)"
description: "Cyborg persona SWEN1022 — QA Automation Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">QA Automation Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1022</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1022`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1022.yaml`
...
The QA Automation Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The QA Automation Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds automated test frameworks and quality gates.
...
flowchart LR
  SWEN1022["SWEN1022"]
  SWEN0005["SWEN0005"] --> SWEN1022
```


## Links

- Machine source: [`cyborgs/SWEN1022.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1022.yaml)
- Job role doc: [SWEN1022](../../../job_roles/engineering_technology/swen1022.md)
