---
title: "SWEN1023 (SWEN1023)"
description: "Cyborg persona SWEN1023 — Staff Frontend Engineer"
...
<div class="cyborg-detail-hero" markdown="0">
  ...
  <div>
    <p class="cyborg-card__subtitle">Staff Frontend Engineer</p>
    <div class="cyborg-card__chips" style="margin-top:0.5rem"><span class="chip chip-jobid">SWEN1023</span><span class="chip chip-security-high">HIGH</span><span class="chip chip-ns-development">cyborg-development</span><span class="chip chip-type">LLM</span><span class="chip chip-tag">Software engineering</span><span class="chip chip-security-critical">HITL required</span></div>
  </div>
</div>

**What's on this page**

- Full machine metadata for `SWEN1023`
- Capabilities, tools, security gates, and system prompt

**What this enables**

- Safe operator review before enabling an agent
- Traceability back to YAML source `cyborgs/SWEN1023.yaml`
...
The Staff Frontend Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. The Staff Frontend Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Frontend technical leadership across products.
...
flowchart LR
  SWEN1023["SWEN1023"]
  SWEN0005["SWEN0005"] --> SWEN1023
```


## Links

- Machine source: [`cyborgs/SWEN1023.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1023.yaml)
- Job role doc: [SWEN1023](../../../job_roles/engineering_technology/swen1023.md)
