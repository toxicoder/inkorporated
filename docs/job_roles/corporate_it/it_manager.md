...
The **IT Manager** (ITOP0006) is a core node in Inkorporated's enterprise operating system. Corporate IT team leadership and service levels. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the IT Manager function with excellence.
...
Source path hint: `docs/job_roles/corporate_it/it_manager.md`
