...
The **Corporate Network Administrator** (ITOP0005) is a core node in Inkorporated's enterprise operating system. The Corporate Network Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Office and corp network reliability. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/corporate_it/itop0005.md`
