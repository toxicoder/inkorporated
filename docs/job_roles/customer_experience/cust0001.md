...
The **Support Engineer L1** (CUST0001) is a core node in Inkorporated's enterprise operating system. The Support Engineer L1 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. First-line customer support and triage. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/customer_experience/cust0001.md`
