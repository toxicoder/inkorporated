...
The **Support Engineer L2** (CUST0002) is a core node in Inkorporated's enterprise operating system. The Support Engineer L2 at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Resolves complex customer issues; bridges support and engineering. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/customer_experience/cust0002.md`
