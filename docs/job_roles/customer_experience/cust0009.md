...
description: "Customer Onboarding Specialist (CUST0009) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Customer Onboarding Specialist** (`CUST0009`)
...
The **Customer Onboarding Specialist** (CUST0009) is a core node in Inkorporated's enterprise operating system. The Customer Onboarding Specialist at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Time-to-value and activation for new customers. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As Customer Onboarding Specialist, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the Customer Onboarding Specialist mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Customer Onboarding Specialist scope
...
Machine persona YAML: [`cyborgs/CUST0009.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0009.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `CUST0009`
...
Source path hint: `docs/job_roles/customer_experience/cust0009.md`
