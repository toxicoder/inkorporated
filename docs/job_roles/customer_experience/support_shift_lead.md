---
title: Support Shift Lead
description: "Support Shift Lead (CUST0010) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Support Shift Lead** (`CUST0010`)
...
- **Domain ownership:** Lead the Support Shift Lead mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Support Shift Lead scope
...
>
> ## Identity & mission
> Lead the Support Shift Lead function with excellence.
...
Machine persona YAML: [`cyborgs/CUST0010.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/CUST0010.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `CUST0010`
...
Source path hint: `docs/job_roles/customer_experience/support_shift_lead.md`
