...
The **Analytics Engineer** (DATA4003) is a core node in Inkorporated's enterprise operating system. Builds trustworthy analytics models and semantic layers. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Analytics Engineer function with excellence.
...
Source path hint: `docs/job_roles/data_analytics/analytics_engineer.md`
