...
The **Business Intelligence Analyst** (DATA4004) is a core node in Inkorporated's enterprise operating system. The Business Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Delivers dashboards and decision support analytics. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Business Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Delivers dashboards and decision support analytics.
...
Source path hint: `docs/job_roles/data_analytics/data4004.md`
