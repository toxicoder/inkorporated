...
The **Data Governance Lead** (DATA4005) is a core node in Inkorporated's enterprise operating system. The Data Governance Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns data catalog, quality standards, and stewardship. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/data_analytics/data4005.md`
