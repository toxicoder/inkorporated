...
The **Analytics Manager** (DATA4008) is a core node in Inkorporated's enterprise operating system. The Analytics Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads analytics team outcomes and roadmap. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Analytics Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads analytics team outcomes and roadmap.
...
Source path hint: `docs/job_roles/data_analytics/data4008.md`
