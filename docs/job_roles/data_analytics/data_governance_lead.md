...
description: "Data Governance Lead (DATA4005) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Data Governance Lead** (`DATA4005`)
...
- **Domain ownership:** Lead the Data Governance Lead mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Data Governance Lead scope
...
>
> ## Identity & mission
> Lead the Data Governance Lead function with excellence.
...
Machine persona YAML: [`cyborgs/DATA4005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DATA4005.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `DATA4005`
...
Source path hint: `docs/job_roles/data_analytics/data_governance_lead.md`
