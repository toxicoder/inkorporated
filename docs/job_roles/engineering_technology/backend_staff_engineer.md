...
description: "Staff Backend Engineer (SWEN1024) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Staff Backend Engineer** (`SWEN1024`)
...
- **Domain ownership:** Lead the Staff Backend Engineer mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Staff Backend Engineer scope
...
>
> ## Identity & mission
> Lead the Staff Backend Engineer function with excellence.
...
Machine persona YAML: [`cyborgs/SWEN1024.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SWEN1024.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SWEN1024`
...
Source path hint: `docs/job_roles/engineering_technology/backend_staff_engineer.md`
