...
The **Developer Experience Engineer** (SWEN1018) is a core node in Inkorporated's enterprise operating system. Improves CI, local dev, templates, and inner loop speed. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Developer Experience Engineer function with excellence.
...
Source path hint: `docs/job_roles/engineering_technology/devex_engineer.md`
