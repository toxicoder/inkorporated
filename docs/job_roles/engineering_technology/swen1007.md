...
The **Platform Engineer** (SWEN1007) is a core node in Inkorporated's enterprise operating system. The Platform Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds internal platforms, paved roads, and developer self-service. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Platform Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds internal platforms, paved roads, and developer self-service.
...
Source path hint: `docs/job_roles/engineering_technology/swen1007.md`
