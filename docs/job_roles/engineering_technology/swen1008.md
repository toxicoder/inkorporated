...
The **Staff Engineer** (SWEN1008) is a core node in Inkorporated's enterprise operating system. The Staff Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Cross-team technical leadership; architecture and execution at L6. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/engineering_technology/swen1008.md`
