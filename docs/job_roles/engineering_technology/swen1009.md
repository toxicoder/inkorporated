...
The **ML Engineer** (SWEN1009) is a core node in Inkorporated's enterprise operating system. The ML Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships production ML systems with reliability and evaluation discipline. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The ML Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships production ML systems with reliability and evaluation discipline.
...
Source path hint: `docs/job_roles/engineering_technology/swen1009.md`
