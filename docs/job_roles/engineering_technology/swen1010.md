...
The **Technical Writer** (SWEN1010) is a core node in Inkorporated's enterprise operating system. The Technical Writer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Creates developer and operator documentation that stays accurate. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/engineering_technology/swen1010.md`
