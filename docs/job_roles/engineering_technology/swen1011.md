...
The **Principal Engineer** (SWEN1011) is a core node in Inkorporated's enterprise operating system. The Principal Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Org-level technical direction and multi-year architecture bets. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Principal Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Org-level technical direction and multi-year architecture bets.
...
Source path hint: `docs/job_roles/engineering_technology/swen1011.md`
