...
The **Release Engineer** (SWEN1013) is a core node in Inkorporated's enterprise operating system. The Release Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns release trains, artifact promotion, and deploy safety. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Release Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns release trains, artifact promotion, and deploy safety.
...
Source path hint: `docs/job_roles/engineering_technology/swen1013.md`
