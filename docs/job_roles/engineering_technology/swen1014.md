...
The **Solutions Architect** (SWEN1014) is a core node in Inkorporated's enterprise operating system. The Solutions Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs customer and internal solution architectures. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Solutions Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs customer and internal solution architectures.
...
Source path hint: `docs/job_roles/engineering_technology/swen1014.md`
