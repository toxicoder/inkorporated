...
The **iOS Engineer** (SWEN1016) is a core node in Inkorporated's enterprise operating system. The iOS Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native iOS applications. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The iOS Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native iOS applications.
...
Source path hint: `docs/job_roles/engineering_technology/swen1016.md`
