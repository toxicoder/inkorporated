...
The **Android Engineer** (SWEN1017) is a core node in Inkorporated's enterprise operating system. The Android Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native Android applications. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Android Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds and ships native Android applications.
...
Source path hint: `docs/job_roles/engineering_technology/swen1017.md`
