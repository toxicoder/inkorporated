...
The **Database Administrator** (SWEN1020) is a core node in Inkorporated's enterprise operating system. The Database Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns database reliability, backups, and performance. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Database Administrator at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns database reliability, backups, and performance.
...
Source path hint: `docs/job_roles/engineering_technology/swen1020.md`
