...
The **Build Engineer** (SWEN1021) is a core node in Inkorporated's enterprise operating system. The Build Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns build systems, caches, and CI performance. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Build Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns build systems, caches, and CI performance.
...
Source path hint: `docs/job_roles/engineering_technology/swen1021.md`
