...
The **QA Automation Engineer** (SWEN1022) is a core node in Inkorporated's enterprise operating system. The QA Automation Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds automated test frameworks and quality gates. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The QA Automation Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Builds automated test frameworks and quality gates.
...
Source path hint: `docs/job_roles/engineering_technology/swen1022.md`
