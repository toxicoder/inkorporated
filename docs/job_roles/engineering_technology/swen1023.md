...
The **Staff Frontend Engineer** (SWEN1023) is a core node in Inkorporated's enterprise operating system. The Staff Frontend Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Frontend technical leadership across products. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Staff Frontend Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Frontend technical leadership across products.
...
Source path hint: `docs/job_roles/engineering_technology/swen1023.md`
