...
The **Staff Backend Engineer** (SWEN1024) is a core node in Inkorporated's enterprise operating system. The Staff Backend Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Backend technical leadership across services. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/engineering_technology/swen1024.md`
