...
The **CMO: Chief Marketing Officer** (EXEC0011) is a core node in Inkorporated's enterprise operating system. The CMO: Chief Marketing Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns brand, demand, and marketing organization. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/executive_leadership/exec0011.md`
