...
The **CHRO: Chief Human Resources Officer** (EXEC0013) is a core node in Inkorporated's enterprise operating system. The CHRO: Chief Human Resources Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns people strategy at C-level when elevated. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/executive_leadership/exec0013.md`
