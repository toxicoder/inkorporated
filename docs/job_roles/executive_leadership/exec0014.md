...
description: "CAO: Chief Administrative Officer (EXEC0014) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **CAO: Chief Administrative Officer** (`EXEC0014`)
...
The **CAO: Chief Administrative Officer** (EXEC0014) is a core node in Inkorporated's enterprise operating system. The CAO: Chief Administrative Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Administrative operations spanning facilities, IT, and ops. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As CAO: Chief Administrative Officer, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the CAO: Chief Administrative Officer mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the CAO: Chief Administrative Officer scope
...
Machine persona YAML: [`cyborgs/EXEC0014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/EXEC0014.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `EXEC0014`
...
Source path hint: `docs/job_roles/executive_leadership/exec0014.md`
