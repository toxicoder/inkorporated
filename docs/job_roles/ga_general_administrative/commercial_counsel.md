...
The **Commercial Counsel** (LEGL7013) is a core node in Inkorporated's enterprise operating system. Customer and vendor contracts at scale. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Commercial Counsel function with excellence.
...
Source path hint: `docs/job_roles/ga_general_administrative/commercial_counsel.md`
