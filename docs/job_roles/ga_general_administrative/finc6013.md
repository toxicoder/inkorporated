...
The **Procurement Manager** (FINC6013) is a core node in Inkorporated's enterprise operating system. The Procurement Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Vendor selection, contracts process, and spend control. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/ga_general_administrative/finc6013.md`
