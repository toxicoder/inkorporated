...
The **FP&A Manager** (FINC6018) is a core node in Inkorporated's enterprise operating system. The FP&A Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Leads planning, forecasting, and business partnering. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/ga_general_administrative/finc6018.md`
