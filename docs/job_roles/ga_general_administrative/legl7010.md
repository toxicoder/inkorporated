...
The **Compliance Officer** (LEGL7010) is a core node in Inkorporated's enterprise operating system. The Compliance Officer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Operates compliance program and regulatory obligations. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/ga_general_administrative/legl7010.md`
