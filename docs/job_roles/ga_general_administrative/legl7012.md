...
The **IP Counsel** (LEGL7012) is a core node in Inkorporated's enterprise operating system. The IP Counsel at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Patents, trademarks, and IP strategy. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/ga_general_administrative/legl7012.md`
