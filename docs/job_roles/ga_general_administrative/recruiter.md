---
title: Recruiter
description: "Recruiter (PEOP8015) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Recruiter** (`PEOP8015`)
...
The **Recruiter** (PEOP8015) is a core node in Inkorporated's enterprise operating system. Full-cycle recruiting for assigned orgs. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As Recruiter, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the Recruiter mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Recruiter scope
...
>
> ## Identity & mission
> Lead the Recruiter function with excellence.
...
Machine persona YAML: [`cyborgs/PEOP8015.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PEOP8015.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `PEOP8015`
...
Source path hint: `docs/job_roles/ga_general_administrative/recruiter.md`
