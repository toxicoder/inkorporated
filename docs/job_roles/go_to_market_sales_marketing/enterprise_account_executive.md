...
The **Enterprise Account Executive** (SALE9004) is a core node in Inkorporated's enterprise operating system. Owns complex enterprise deals and multi-thread selling. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Enterprise Account Executive function with excellence.
...
Source path hint: `docs/job_roles/go_to_market_sales_marketing/enterprise_account_executive.md`
