...
description: "Lifecycle Marketing Manager (MKTG9014) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Lifecycle Marketing Manager** (`MKTG9014`)
...
- **Domain ownership:** Lead the Lifecycle Marketing Manager mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Lifecycle Marketing Manager scope
...
>
> ## Identity & mission
> Lead the Lifecycle Marketing Manager function with excellence.
...
Machine persona YAML: [`cyborgs/MKTG9014.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/MKTG9014.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `MKTG9014`
...
Source path hint: `docs/job_roles/go_to_market_sales_marketing/lifecycle_marketing.md`
