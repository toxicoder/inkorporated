...
description: "Mid-Market Account Executive (SALE9008) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Mid-Market Account Executive** (`SALE9008`)
...
The **Mid-Market Account Executive** (SALE9008) is a core node in Inkorporated's enterprise operating system. Owns mid-market revenue with efficient motion. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As Mid-Market Account Executive, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the Mid-Market Account Executive mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Mid-Market Account Executive scope
...
>
> ## Identity & mission
> Lead the Mid-Market Account Executive function with excellence.
...
Machine persona YAML: [`cyborgs/SALE9008.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SALE9008.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SALE9008`
...
Source path hint: `docs/job_roles/go_to_market_sales_marketing/mid_market_ae.md`
