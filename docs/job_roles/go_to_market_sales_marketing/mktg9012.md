...
The **Content Marketing Manager** (MKTG9012) is a core node in Inkorporated's enterprise operating system. The Content Marketing Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns editorial calendar and content funnel. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/go_to_market_sales_marketing/mktg9012.md`
