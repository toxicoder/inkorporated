...
The **Revenue Operations** (SALE9010) is a core node in Inkorporated's enterprise operating system. The Revenue Operations at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns GTM systems, funnel metrics, and operating cadence. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/go_to_market_sales_marketing/sale9010.md`
