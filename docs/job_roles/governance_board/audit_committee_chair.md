...
The **Audit Committee Chair** (BOARD0003) is a core node in Inkorporated's enterprise operating system. Oversees financial reporting integrity and auditors. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Audit Committee Chair function with excellence.
...
Source path hint: `docs/job_roles/governance_board/audit_committee_chair.md`
