...
The **Board Chair** (BOARD0001) is a core node in Inkorporated's enterprise operating system. Governs the board agenda, partner to CEO, ensures fiduciary oversight. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Board Chair function with excellence.
...
Source path hint: `docs/job_roles/governance_board/board_chair.md`
