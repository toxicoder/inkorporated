...
description: "Corporate Secretary (BOARD0002) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Corporate Secretary** (`BOARD0002`)
...
- **Domain ownership:** Lead the Corporate Secretary mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Corporate Secretary scope
...
>
> ## Identity & mission
> Lead the Corporate Secretary function with excellence.
...
Machine persona YAML: [`cyborgs/BOARD0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/BOARD0002.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `BOARD0002`
...
Source path hint: `docs/job_roles/governance_board/corporate_secretary.md`
