...
description: "Brand Designer (DESN3005) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Brand Designer** (`DESN3005`)
...
- **Domain ownership:** Lead the Brand Designer mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Brand Designer scope
...
>
> ## Identity & mission
> Lead the Brand Designer function with excellence.
...
Machine persona YAML: [`cyborgs/DESN3005.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/DESN3005.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `DESN3005`
...
Source path hint: `docs/job_roles/product_design/brand_designer.md`
