---
title: DirProduct
description: "DirProduct (PROD0002) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **DirProduct** (`PROD0002`)
...
- **Domain ownership:** Lead the DirProduct mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the DirProduct scope
...
Machine persona YAML: [`cyborgs/PROD0002.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD0002.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `PROD0002`
...
Source path hint: `docs/job_roles/product_design/director_of_product.md`
