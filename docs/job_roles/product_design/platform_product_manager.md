...
The **Platform Product Manager** (PROD2004) is a core node in Inkorporated's enterprise operating system. Owns internal platform product outcomes. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> Lead the Platform Product Manager function with excellence.
...
Source path hint: `docs/job_roles/product_design/platform_product_manager.md`
