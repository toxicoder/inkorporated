---
title: Product_Visionary
description: "Product_Visionary (PROD2001) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Product_Visionary** (`PROD2001`)
...
- **Domain ownership:** Lead the Product_Visionary mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Product_Visionary scope
...
**Agent name:** `Product_Visionary_Agent`
...
Machine persona YAML: [`cyborgs/PROD2001.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/PROD2001.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `PROD2001`
...
Source path hint: `docs/job_roles/product_design/prod2001.md`
