...
The **Growth Product Manager** (PROD2003) is a core node in Inkorporated's enterprise operating system. The Growth Product Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns acquisition, activation, and retention product loops. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/product_design/prod2003.md`
