...
description: "Country Operations Manager (REGN0004) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Country Operations Manager** (`REGN0004`)
...
- **Domain ownership:** Lead the Country Operations Manager mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Country Operations Manager scope
...
>
> ## Identity & mission
> Lead the Country Operations Manager function with excellence.
...
Machine persona YAML: [`cyborgs/REGN0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/REGN0004.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `REGN0004`
...
Source path hint: `docs/job_roles/regional_operations/country_ops_manager.md`
