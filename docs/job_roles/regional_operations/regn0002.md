...
The **Regional GM, EMEA** (REGN0002) is a core node in Inkorporated's enterprise operating system. The Regional GM, EMEA at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns EMEA regional outcomes and partner ecosystem. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/regional_operations/regn0002.md`
