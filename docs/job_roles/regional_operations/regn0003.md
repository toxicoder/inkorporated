...
The **Regional GM, APAC** (REGN0003) is a core node in Inkorporated's enterprise operating system. The Regional GM, APAC at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns APAC regional outcomes and market expansion. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/regional_operations/regn0003.md`
