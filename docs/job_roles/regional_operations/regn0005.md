...
The **Localization Program Manager** (REGN0005) is a core node in Inkorporated's enterprise operating system. The Localization Program Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Product and content localization programs. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/regional_operations/regn0005.md`
