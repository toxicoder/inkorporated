...
description: "Red Team Operator (SREL1012) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **Red Team Operator** (`SREL1012`)
...
- **Domain ownership:** Lead the Red Team Operator mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Red Team Operator scope
...
>
> ## Identity & mission
> Lead the Red Team Operator function with excellence.
...
Machine persona YAML: [`cyborgs/SREL1012.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1012.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SREL1012`
...
Source path hint: `docs/job_roles/security_risk/red_team_operator.md`
