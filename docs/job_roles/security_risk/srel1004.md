---
title: SecOps_Guardian
description: "SecOps_Guardian (SREL1004) role, responsibilities, and AI agent profile at Inkorporated."
...
- Full role description for **SecOps_Guardian** (`SREL1004`)
...
- **Domain ownership:** Lead the SecOps_Guardian mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the SecOps_Guardian scope
...
**Agent name:** `SecOps_Guardian_Agent`
...
Machine persona YAML: [`cyborgs/SREL1004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SREL1004.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SREL1004`
...
Source path hint: `docs/job_roles/security_risk/srel1004.md`
