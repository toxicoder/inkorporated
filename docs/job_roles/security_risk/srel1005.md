...
The **Application Security Engineer** (SREL1005) is a core node in Inkorporated's enterprise operating system. The Application Security Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Embeds security in SDLC; threat models, reviews, and secure defaults. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Application Security Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Embeds security in SDLC; threat models, reviews, and secure defaults.
...
Source path hint: `docs/job_roles/security_risk/srel1005.md`
