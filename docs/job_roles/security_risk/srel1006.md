...
The **SOC Analyst** (SREL1006) is a core node in Inkorporated's enterprise operating system. The SOC Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Detects and triages security events; drives incident containment. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The SOC Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Detects and triages security events; drives incident containment.
...
Source path hint: `docs/job_roles/security_risk/srel1006.md`
