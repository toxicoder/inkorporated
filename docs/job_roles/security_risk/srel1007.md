...
The **GRC Analyst** (SREL1007) is a core node in Inkorporated's enterprise operating system. The GRC Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Maps controls, evidence, and policy to customer and regulatory needs. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/security_risk/srel1007.md`
