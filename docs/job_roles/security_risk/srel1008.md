...
The **Security Architect** (SREL1008) is a core node in Inkorporated's enterprise operating system. The Security Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs security architecture and control patterns. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Security Architect at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Designs security architecture and control patterns.
...
Source path hint: `docs/job_roles/security_risk/srel1008.md`
