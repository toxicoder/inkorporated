...
The **IAM Engineer** (SREL1009) is a core node in Inkorporated's enterprise operating system. The IAM Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Identity systems, federation, and least-privilege access. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The IAM Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Identity systems, federation, and least-privilege access.
...
Source path hint: `docs/job_roles/security_risk/srel1009.md`
