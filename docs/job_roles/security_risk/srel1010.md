...
The **Threat Intelligence Analyst** (SREL1010) is a core node in Inkorporated's enterprise operating system. The Threat Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Tracks threats and enriches detection content. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Threat Intelligence Analyst at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Tracks threats and enriches detection content.
...
Source path hint: `docs/job_roles/security_risk/srel1010.md`
