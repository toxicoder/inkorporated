...
The **Detection Engineer** (SREL1014) is a core node in Inkorporated's enterprise operating system. The Detection Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Authors high-signal detections and response playbooks. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Detection Engineer at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Authors high-signal detections and response playbooks.
...
Source path hint: `docs/job_roles/security_risk/srel1014.md`
