...
The **SRE Manager** (SREL1015) is a core node in Inkorporated's enterprise operating system. The SRE Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. People leadership for reliability engineers. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The SRE Manager at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. People leadership for reliability engineers.
...
Source path hint: `docs/job_roles/security_risk/srel1015.md`
