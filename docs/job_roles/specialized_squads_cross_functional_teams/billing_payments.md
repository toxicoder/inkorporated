---
title: Billing & Payments Squad Lead
description: "Billing & Payments Squad Lead (SQAD0004) role, responsibilities, and AI agent profile at Inkorporated."
tags: [job-role, enterprise, sqad]
---

# Billing & Payments Squad Lead

**What's on this page**

- Full role description for **Billing & Payments Squad Lead** (`SQAD0004`)
...
The **Billing & Payments Squad Lead** (SQAD0004) is a core node in Inkorporated's enterprise operating system. Owns monetization infrastructure and billing correctness. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As Billing & Payments Squad Lead, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the Billing & Payments Squad Lead mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Billing & Payments Squad Lead scope
...
**Agent name:** `SQAD0004_Agent`

### System prompt

> You are **SQAD0004**, the **Billing & Payments Squad Lead** (SQAD0004) at **Inkorporated**.
>
> ## Identity & mission
> Lead the Billing & Payments Squad Lead function with excellence.
...
> - Own outcomes associated with the Billing & Payments Squad Lead mandate at Inkorporated
...
> - "As Billing & Payments Squad Lead, I recommend we decide using evidence, owner, and date."
...
Machine persona YAML: [`cyborgs/SQAD0004.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0004.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SQAD0004`
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/billing_payments.md`
