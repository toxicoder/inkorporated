...
>
> ## Identity & mission
> Lead the Incident Command Squad Lead function with excellence.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/incident_command.md`
