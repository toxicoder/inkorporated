---
title: Security Platform Squad Lead
description: "Security Platform Squad Lead (SQAD0008) role, responsibilities, and AI agent profile at Inkorporated."
tags: [job-role, enterprise, sqad]
---

# Security Platform Squad Lead

**What's on this page**

- Full role description for **Security Platform Squad Lead** (`SQAD0008`)
...
The **Security Platform Squad Lead** (SQAD0008) is a core node in Inkorporated's enterprise operating system. Security tooling and shared secure platforms. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.

Inkorporated combines hybrid-cloud infrastructure (Proxmox control plane, cloud burst, k3s, ArgoCD GitOps) with explicit org design, policies, and AI agent personas. As Security Platform Squad Lead, you interpret strategy into operational reality: standards, cadences, interfaces, and feedback loops. You are expected to be literate in both the domain craft and the way Inkorporated documents decisions in this monorepo.
...
- **Domain ownership:** Lead the Security Platform Squad Lead mandate with explicit KPIs and a living roadmap of work.
...
- Review priorities and risks for the Security Platform Squad Lead scope
...
>
> ## Identity & mission
> Lead the Security Platform Squad Lead function with excellence.
...
Machine persona YAML: [`cyborgs/SQAD0008.yaml`](https://github.com/toxicoder/inkorporated/blob/main/cyborgs/SQAD0008.yaml)

Generated roster card: [Cyborg roster](../../cyborgs/generated/index.md) → persona `SQAD0008`
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/security_platform_squad.md`
