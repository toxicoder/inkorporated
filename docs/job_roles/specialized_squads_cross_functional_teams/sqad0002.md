...
The **Platform Foundations Squad Lead** (SQAD0002) is a core node in Inkorporated's enterprise operating system. The Platform Foundations Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns core platform reliability and paved roads. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Platform Foundations Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns core platform reliability and paved roads.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0002.md`
