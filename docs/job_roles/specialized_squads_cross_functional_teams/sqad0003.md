...
The **AI Product Squad Lead** (SQAD0003) is a core node in Inkorporated's enterprise operating system. The AI Product Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships AI product capabilities with safety reviews. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The AI Product Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Ships AI product capabilities with safety reviews.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0003.md`
