...
The **Billing & Payments Squad Lead** (SQAD0004) is a core node in Inkorporated's enterprise operating system. The Billing & Payments Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns monetization infrastructure and billing correctness. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Billing & Payments Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns monetization infrastructure and billing correctness.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0004.md`
