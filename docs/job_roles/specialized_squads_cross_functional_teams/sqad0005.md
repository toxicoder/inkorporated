...
The **Trust & Safety Squad Lead** (SQAD0005) is a core node in Inkorporated's enterprise operating system. The Trust & Safety Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns abuse prevention and trust systems. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Trust & Safety Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Owns abuse prevention and trust systems.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0005.md`
