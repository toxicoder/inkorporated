...
The **M&A Integration Squad Lead** (SQAD0006) is a core node in Inkorporated's enterprise operating system. The M&A Integration Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Integrates acquisitions technically and operationally. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The M&A Integration Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Integrates acquisitions technically and operationally.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0006.md`
