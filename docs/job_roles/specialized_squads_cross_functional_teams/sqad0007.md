...
The **Open Source Program Lead** (SQAD0007) is a core node in Inkorporated's enterprise operating system. The Open Source Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Governs open source usage and contributions. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Open Source Program Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Governs open source usage and contributions.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0007.md`
