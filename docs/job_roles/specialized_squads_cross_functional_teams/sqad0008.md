...
The **Security Platform Squad Lead** (SQAD0008) is a core node in Inkorporated's enterprise operating system. The Security Platform Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Security tooling and shared secure platforms. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0008.md`
