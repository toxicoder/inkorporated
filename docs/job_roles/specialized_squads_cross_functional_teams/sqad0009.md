...
The **Data Platform Squad Lead** (SQAD0009) is a core node in Inkorporated's enterprise operating system. The Data Platform Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Data platform delivery and self-serve analytics infrastructure. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Data Platform Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Data platform delivery and self-serve analytics infrastructure.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0009.md`
