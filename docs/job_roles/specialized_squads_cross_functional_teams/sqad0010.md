...
The **Enterprise Readiness Squad Lead** (SQAD0010) is a core node in Inkorporated's enterprise operating system. The Enterprise Readiness Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Enterprise feature completeness and launch gates. Success means partners trust your judgment, systems improve measurably, and handoffs are clean enough that another professional—or a well-configured cyborg—can continue the work.
...
>
> ## Identity & mission
> The Enterprise Readiness Squad Lead at Inkorporated drives outcomes for their function with clear ownership, cross-functional partnership, and high standards for quality, security, and documentation. Enterprise feature completeness and launch gates.
...
Source path hint: `docs/job_roles/specialized_squads_cross_functional_teams/sqad0010.md`
